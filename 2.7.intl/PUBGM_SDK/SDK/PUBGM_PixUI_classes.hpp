...
public:
	...
	struct FScriptDelegate                             pixuiVmOpenDelegate;                                      // 0x0080(0x000C) (Edit, ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             pixuiVmConfirmDelegate;                                   // 0x00A8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x00A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             pixuiVmPrompDelegate;                                     // 0x00B8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x00B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData05[0x8];                                       // 0x00F8(0x0008) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             pixuiWinOpenDelegate;                                     // 0x0158(0x000C) (Edit, ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             pixuiWinConfirmDelegate;                                  // 0x0180(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0180(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             pixuiWinPrompDelegate;                                    // 0x0190(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0190(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData05[0x100];                                     // 0x01D0(0x0100) MISSED OFFSET
