...
{
public:
	struct FString                                     UserDescription;                                          // 0x001C(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
...
{
public:
	struct FString                                     ConfigFilename;                                           // 0x001C(0x000C) (ZeroConstructor)
...
{
public:
	struct FString                                     DeveloperConfigName;                                      // 0x001C(0x000C) (Edit, ZeroConstructor, Config)
