...
public:
	...
	unsigned char                                      bAutoRegisterWithBudgetAllocator : 1;                     // 0x0B40(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bAutoCalculateSignificance : 1;                           // 0x0B40(0x0001) (Edit)
	unsigned char                                      bShouldUseActorRenderedFlag : 1;                          // 0x0B40(0x0001) (Edit)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0B41(0x000F) MISSED OFFSET
