...
{
public:
	unsigned char                                      UnknownData00[0x48];                                      // 0x03A8(0x0048) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x12C];                                     // 0x00C0(0x012C) MISSED OFFSET
	TArray<struct FAttrModifyItem>                     ConfigAttrModifyList;                                     // 0x01EC(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	uint32_t                                           AttrModifyStateList;                                      // 0x01F8(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x58];                                      // 0x01FC(0x0058) MISSED OFFSET
	struct FRepAttributeModify                         DynamicModifierRep;                                       // 0x0254(0x0010) (Net)
	struct FRepAttributeModify                         DynamicModifierRepOnlyOwner;                              // 0x0264(0x0010) (Net)
	unsigned char                                      UnknownData02[0x14];                                      // 0x0274(0x0014) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnAttrModified;                                           // 0x0288(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAttrRemoved;                                            // 0x0294(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FAttrDynamicModifier                        DynamicModifier;                                          // 0x02A0(0x007C)
	unsigned char                                      UnknownData03[0x3C];                                      // 0x031C(0x003C) MISSED OFFSET
	TArray<struct FAttributeExpand>                    AttributeExpands;                                         // 0x0358(0x000C) (Edit, ZeroConstructor)
	TMap<struct FString, struct FRelateAttributeGroup> RelateAttributeGroup;                                     // 0x0364(0x0050) (ZeroConstructor)
	EActorRegAttrTableType                             ActorAttrType;                                            // 0x03A0(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC7];                                      // 0x03A1(0x00C7) MISSED OFFSET
	TArray<struct FModAttrSimulateSyncItem>            ModSimulateSyncList;                                      // 0x0468(0x000C) (Net, ZeroConstructor)
	unsigned char                                      UnknownData05[0xC8];                                      // 0x0474(0x00C8) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnNeedSetSpeedOverLimit;                                  // 0x053C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	class APlayerController*                           OwningController;                                         // 0x0310(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	bool                                               bUseBoneRetargetLODFeature;                               // 0x0B30(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0B31(0x000F) MISSED OFFSET
...
// 0x0280 (0x2B480 - 0x2B200)
class UUAENetConnection : public UIpConnection
{
public:
	unsigned char                                      UnknownData00[0x90];                                      // 0x2B200(0x0090) MISSED OFFSET
	int                                                InitialHandshakeTimeoutNumThreshold;                      // 0x2B290(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x2B294(0x0004) MISSED OFFSET
	int                                                ActorChannelProcessBunchErrorNumThreshold_Server_Global;  // 0x2B298(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_Global;  // 0x2B29C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_PerActor;// 0x2B2A0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x2B2A4(0x003C) MISSED OFFSET
	bool                                               bEnableHTTPDNS;                                           // 0x2B2E0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x2B2E1(0x0003) MISSED OFFSET
	struct FString                                     HTTPDNSServerAddr;                                        // 0x2B2E4(0x000C) (ZeroConstructor, Config)
	float                                              HTTPDNSResponseTimeout;                                   // 0x2B2F0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x2B2F4(0x000C) MISSED OFFSET
	float                                              CheckLevelInitializedTime;                                // 0x2B300(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckLevelActorsOvertime;                                 // 0x2B304(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              TempCheckLevelInitializedTime;                            // 0x2B308(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, struct FUnLoadLevelActorCollection> UnLevelInitActors;                                        // 0x2B30C(0x0050) (ZeroConstructor)
	class UNetRelevancyGroup*                          RelevancyGroup;                                           // 0x2B348(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC8];                                      // 0x2B34C(0x00C8) MISSED OFFSET
	TArray<struct FPendingRegionNetworkObject>         PendingRegionNetworkObjects;                              // 0x2B414(0x000C) (ZeroConstructor)
	float                                              MinRegionActorTickDelta;                                  // 0x2B420(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxRegionActorTickDelta;                                  // 0x2B424(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x2B428(0x000C) MISSED OFFSET
	bool                                               EnableWeakNetUpdate;                                      // 0x2B434(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x2B435(0x0003) MISSED OFFSET
	float                                              MinWeakNetUpdateDelay;                                    // 0x2B438(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxWeakNetUpdateDelay;                                    // 0x2B43C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SquareSegmentSize;                                        // 0x2B440(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxSegmentDistance;                                       // 0x2B444(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxObjectNumInSegments;                                   // 0x2B448(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0xD];                                       // 0x2B44C(0x000D) MISSED OFFSET
	bool                                               bRecreateSocketOnLost;                                    // 0x2B459(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x12];                                      // 0x2B45A(0x0012) MISSED OFFSET
	float                                              UpdateClientPingTimeThreshold;                            // 0x2B46C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x10];                                      // 0x2B470(0x0010) MISSED OFFSET
...
// 0x041C (0x0438 - 0x001C)
class UUAETableManager : public UObject
{
public:
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             OnMemWarning;                                             // 0x0020(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FString                                     TableRelativeDir;                                         // 0x0030(0x000C) (ZeroConstructor, Config)
	TArray<struct FName>                               TablesNeedReleasedInBattle;                               // 0x003C(0x000C) (ZeroConstructor, Config)
	struct FString                                     ManualTableDirectory;                                     // 0x0048(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0xC0];                                      // 0x0054(0x00C0) MISSED OFFSET
	bool                                               AllowItemTable;                                           // 0x0114(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0115(0x0003) MISSED OFFSET
	TArray<class UUAEDataTable*>                       TableObjList;                                             // 0x0118(0x000C) (ZeroConstructor)
	class UWorld*                                      CurWorld;                                                 // 0x0124(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> TableObjMap;                                              // 0x0128(0x0050) (ZeroConstructor)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> TableObjMap_Mod;                                          // 0x0164(0x0050) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnTableCreateInFighting;                                  // 0x01A0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0xCC];                                      // 0x01AC(0x00CC) MISSED OFFSET
	struct FString                                     PathCompressionConfigsPath;                               // 0x0278(0x000C) (ZeroConstructor, Config)
	bool                                               bIsPathCompression;                                       // 0x0284(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsPathCompressionCache;                                  // 0x0285(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0286(0x0002) MISSED OFFSET
	int                                                PathCompressionCacheMaxSize;                              // 0x0288(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bTranslationFallBackUnloadDuplicate;                      // 0x028C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bShrinkTranslationMap;                                    // 0x028D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0x6];                                       // 0x028E(0x0006) MISSED OFFSET
	struct FString                                     BaseTableRelativeDir;                                     // 0x0294(0x000C) (ZeroConstructor, Config)
	struct FString                                     ModTableRelativeDir;                                      // 0x02A0(0x000C) (ZeroConstructor, Config)
	TMap<struct FName, class UModTable*>               ModTableMap;                                              // 0x02AC(0x0050) (ZeroConstructor)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> ModTableObjMap;                                           // 0x02E8(0x0050) (ZeroConstructor)
	TArray<class UUAEDataTable*>                       InGameTableObjList;                                       // 0x0324(0x000C) (ZeroConstructor)
	TMap<struct FName, bool>                           CheckNeedModMap;                                          // 0x0330(0x0050) (ZeroConstructor)
	struct FString                                     CurrentModName;                                           // 0x036C(0x000C) (ZeroConstructor)
	struct FString                                     EmptyModName;                                             // 0x0378(0x000C) (ZeroConstructor)
	TMap<struct FString, class UBaseTableResMap*>      LoadedTableMap;                                           // 0x0384(0x0050) (ZeroConstructor)
	TMap<struct FString, bool>                         CheckMapTable;                                            // 0x03C0(0x0050) (ZeroConstructor)
	TMap<struct FString, class UDataTableProxy*>       TableCache;                                               // 0x03FC(0x0050) (ZeroConstructor)
