...
{
public:
	float                                              interval;                                                 // 0x0308(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FVector>                             PortalLoctions;                                           // 0x030C(0x000C) (Edit, ZeroConstructor)
...
public:
	...
	bool                                               bRoutePointInited;                                        // 0x00C8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00C9(0x0003) MISSED OFFSET
	TArray<class AXTPoint*>                            RoutePoints;                                              // 0x00CC(0x000C) (ZeroConstructor)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00C0(0x0008) MISSED OFFSET
	int                                                MaxMoveTime;                                              // 0x00C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxDstStayTime;                                           // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                KillAllTime;                                              // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                StatRecordTime;                                           // 0x00D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UClass*                                      CharacterClass;                                           // 0x0BD8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
