...
public:
	...
	struct FScriptDelegate                             OnScanningSuccess;                                        // 0x00E0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00DD(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
