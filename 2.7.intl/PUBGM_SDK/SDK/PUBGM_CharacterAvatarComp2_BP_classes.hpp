...
// 0x00BC (0x0D9C - 0x0CE0)
class UCharacterAvatarComp2_BP_C : public UCharacterAvatarComponent2
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0CE0(0x0004) (Transient, DuplicateTransient)
	class UBackpackAvatarItemColor*                    BasedAvatarColorHandle;                                   // 0x0CE4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UBackpackAvatarItemPattern*                  BasedAvatarPatternHandle;                                 // 0x0CE8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<int>                                        HoodClothSubTypeMap;                                      // 0x0CEC(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	EBattleItemUseReason                               PreEquipClothReason;                                      // 0x0CF8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0CF9(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData01[0x28];                                      // 0x0CF9(0x0028) UNKNOWN PROPERTY: SoftObjectProperty CharacterAvatarComp2_BP.CharacterAvatarComp2_BP_C.MaleBatchBodySoftPath
	unsigned char                                      UnknownData02[0x28];                                      // 0x0D28(0x0028) UNKNOWN PROPERTY: SoftObjectProperty CharacterAvatarComp2_BP.CharacterAvatarComp2_BP_C.FemaleBatchBodySoftPath
	bool                                               bForbidBindAvatarEquippedEvent;                           // 0x0D50(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0D51(0x0003) MISSED OFFSET
	TArray<int>                                        NeedModifyVehicleID;                                      // 0x0D54(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TMap<EAvatarSlotType, int>                         SlotToFakeHandleMap;                                      // 0x0D60(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
