...
void UVehicleAvatarComponent_BP_C::BPBeginPlay()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function VehicleAvatarComponent_BP.VehicleAvatarComponent_BP_C.BPBeginPlay");

	UVehicleAvatarComponent_BP_C_BPBeginPlay_Params params;
