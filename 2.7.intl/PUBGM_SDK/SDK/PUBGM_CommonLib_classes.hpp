...
{
public:
	struct FScriptMulticastDelegate                    OnProgress;                                               // 0x001C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	TMap<struct FName, struct FServiceCollection>      Services;                                                 // 0x001C(0x0050) (ZeroConstructor)
