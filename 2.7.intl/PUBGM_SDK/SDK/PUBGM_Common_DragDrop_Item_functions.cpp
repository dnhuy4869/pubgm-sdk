...
// Function Common_DragDrop_Item.Common_DragDrop_Item_C.SetDragPivot
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EDragPivot                     dragPivot                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UCommon_DragDrop_Item_C::SetDragPivot(EDragPivot dragPivot)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Common_DragDrop_Item.Common_DragDrop_Item_C.SetDragPivot");

	UCommon_DragDrop_Item_C_SetDragPivot_Params params;
	params.dragPivot = dragPivot;
