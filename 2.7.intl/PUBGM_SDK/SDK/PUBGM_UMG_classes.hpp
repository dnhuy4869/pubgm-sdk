...
{
public:
	struct FScriptDelegate                             bIsEnabledDelegate;                                       // 0x0020(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0020(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       ToolTipText;                                              // 0x0030(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x4];                                       // 0x003C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             ToolTipTextDelegate;                                      // 0x0040(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             ToolTipWidgetDelegate;                                    // 0x0058(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0054(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             VisibilityDelegate;                                       // 0x0068(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0068(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData06[0x2];                                       // 0x00A6(0x0002) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x18];                                      // 0x00AC(0x0018) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x00E8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00E4(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             ForegroundColorDelegate;                                  // 0x0118(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FScriptDelegate                             OnTouchStart;                                             // 0x0160(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0160(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnTouchMove;                                              // 0x0170(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0170(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnTouchEnd;                                               // 0x0180(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0180(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData08 : 1;                                        // 0x01A4(0x0001)
	...
	unsigned char                                      UnknownData11[0x4C];                                      // 0x01BC(0x004C) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0D08(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0D06(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData03[0x10];                                      // 0x0D18(0x0010) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x2C];                                      // 0x0D4C(0x002C) MISSED OFFSET
...
{
public:
	float                                              RTScale;                                                  // 0x0630(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetSpace                                       Space;                                                    // 0x0634(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetTimingPolicy                                TimingPolicy;                                             // 0x0635(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0636(0x0002) MISSED OFFSET
	class UClass*                                      WidgetClass;                                              // 0x0638(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x063C(0x0008) (Edit, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0644(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0645(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0646(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x0648(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x064C(0x000C) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0658(0x0008) (IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0660(0x0004) MISSED OFFSET
	bool                                               bDrawAtDesiredSize;                                       // 0x0664(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0665(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x0668(0x0008) (Edit, IsPlainOldData)
	bool                                               bReceiveHardwareInput;                                    // 0x0670(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x0671(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0672(0x0002) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0674(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0678(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x0688(0x0010) (Edit, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0698(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x069C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x069D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x069E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x1];                                       // 0x069F(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x06A0(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData07[0x10];                                      // 0x06A4(0x0010) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x06B4(0x0004) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA;                                    // 0x06B8(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA_OneSided;                           // 0x06BC(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x06C0(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x06C4(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x06C8(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x06CC(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x06D0(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x06D4(0x0004) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x06D8(0x0004) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x06DC(0x0004) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x06E0(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x06E1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x6];                                       // 0x06E2(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x06E8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x06F0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EWidgetGeometryMode                                GeometryMode;                                             // 0x06F4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x06F5(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x06F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x34];                                      // 0x06FC(0x0034) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ValueDelegate;                                            // 0x00D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00D4(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData05[0xC];                                       // 0x03C4(0x000C) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0418(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0414(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	struct FText                                       Text;                                                     // 0x00D0(0x0018) (Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00DC(0x0004) MISSED OFFSET
	struct FScriptDelegate                             TextDelegate;                                             // 0x00E0(0x000C) (ZeroConstructor, InstancedReference)
	...
	struct FText                                       HintText;                                                 // 0x0984(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0990(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0990(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData05[0xC];                                       // 0x0A4C(0x000C) MISSED OFFSET
...
{
public:
	bool                                               bIsEnhancedImage;                                         // 0x00D0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00D1(0x0007) MISSED OFFSET
	struct FSlateBrush                                 Brush;                                                    // 0x00D8(0x0098) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             BrushDelegate;                                            // 0x0170(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0170(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSetBrushAsyncComplete;                                  // 0x0180(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0180(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FLinearColor                                ColorAndOpacity;                                          // 0x0190(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x01A0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bIsUseEnhancedHitTest;                                    // 0x01B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVersionImg;                                              // 0x01B1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x01B2(0x0002) MISSED OFFSET
	struct FString                                     imageSrcPath;                                             // 0x01B4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              HitTestAreaRadius;                                        // 0x01C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFixOverScale;                                            // 0x01C4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x01C5(0x0003) MISSED OFFSET
	struct FVector2D                                   ScalePivot;                                               // 0x01C8(0x0008) (Edit, IsPlainOldData)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01D0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData06[0x4];                                       // 0x01D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bDontPaintWhenAlphaZero;                                  // 0x01E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenColorZero;                                  // 0x01E1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAsyncLoadImageAsset;                                     // 0x01E2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x5];                                       // 0x01E3(0x0005) MISSED OFFSET
	struct FSoftObjectPath                             AsyncLoadResourcePath;                                    // 0x01E8(0x0018)
	unsigned char                                      UnknownData08[0x10];                                      // 0x0200(0x0010) MISSED OFFSET
...
{
public:
	TWeakObjectPtr<class UObject>                      SourceObject;                                             // 0x001C(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             ContentColorAndOpacityDelegate;                           // 0x00F0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00F0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             BackgroundDelegate;                                       // 0x01A8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x01A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FLinearColor                                BrushColor;                                               // 0x01B8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             BrushColorDelegate;                                       // 0x01C8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x01C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector2D                                   DesiredSizeScale;                                         // 0x01D8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01E0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseButtonUpEvent;                                     // 0x01F0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x01F0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseMoveEvent;                                         // 0x0200(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0200(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseDoubleClickEvent;                                  // 0x0210(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0210(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData07[0xE];                                       // 0x0222(0x000E) MISSED OFFSET
...
{
public:
	struct FScriptDelegate                             CheckedStateDelegate;                                     // 0x00E0(0x000C) (ZeroConstructor, InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x00DC(0x0004) MISSED OFFSET
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x00E0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00DC(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	struct FString                                     Tag;                                                      // 0x001C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	struct FScriptDelegate                             TextDelegate;                                             // 0x00E0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00DC(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       HintText;                                                 // 0x00F0(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00FC(0x0004) MISSED OFFSET
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0100(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x00FC(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData05[0x1];                                       // 0x03BB(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x8];                                       // 0x03D8(0x0008) MISSED OFFSET
...
public:
	...
	struct FText                                       KeySelectionText;                                         // 0x05E0(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FText                                       NoKeySpecifiedText;                                       // 0x05EC(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
...
public:
	...
	struct FScriptDelegate                             OnGenerateRowEvent;                                       // 0x00E8(0x000C) (Edit, ZeroConstructor, InstancedReference)
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x00E4(0x0004) MISSED OFFSET
	struct FScriptDelegate                             OnGetMenuContentEvent;                                    // 0x00E8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x00FB(0x0001) MISSED OFFSET
...
public:
	...
	struct FText                                       HintText;                                                 // 0x0100(0x0018) (Edit)
	unsigned char                                      UnknownData01[0x4];                                       // 0x010C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0110(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x010C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData04[0x3];                                       // 0x0349(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0xC];                                       // 0x0364(0x000C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData04[0x8];                                       // 0x0C20(0x0008) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             PercentDelegate;                                          // 0x02C0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x02C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FLinearColor                                FillColorAndOpacity;                                      // 0x02D0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FScriptDelegate                             FillColorAndOpacityDelegate;                              // 0x02E0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x02E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00F8(0x0008) MISSED OFFSET
	struct FScriptDelegate                             TextDelegate;                                             // 0x0100(0x000C) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData02[0x1EC];                                     // 0x016C(0x01EC) MISSED OFFSET
...
{
public:
	bool                                               bReveal;                                                  // 0x001C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bSingleLayoutPass;                                        // 0x00E9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EHorizontalAlignment>                  HorizontalAlignment;                                      // 0x0034(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EVerticalAlignment>                    VerticalAlignment;                                        // 0x0035(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bAdaptAutoWrapText;                                       // 0x0036(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x9];                                       // 0x0037(0x0009) MISSED OFFSET
...
{
public:
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3C];                                      // 0x0020(0x003C) UNKNOWN PROPERTY: SetProperty UMG.ShareWidgetRT.AllSharedWidget
...
{
public:
	TMap<class UObject*, class UShareWidgetRT*>        SharedWidgetRTMap;                                        // 0x0308(0x0050) (ZeroConstructor)
...
{
public:
	class UTexture2D*                                  DataTexture;                                              // 0x001C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x400];                                     // 0x0020(0x0400) MISSED OFFSET
...
{
public:
	TArray<struct FSlateMeshVertex>                    VertexData;                                               // 0x001C(0x000C) (ZeroConstructor)
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0130(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x012C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x01D8(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x01D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData06[0xA];                                       // 0x01EE(0x000A) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGenerateTileEvent;                                      // 0x00E8(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00E5(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData02[0x8];                                       // 0x00F8(0x0008) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnHoveredWidgetChanged;                                   // 0x0260(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x8];                                       // 0x026C(0x0008) MISSED OFFSET
	int                                                VirtualUserIndex;                                         // 0x0274(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PointerIndex;                                             // 0x0278(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     TraceChannel;                                             // 0x027C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x027D(0x0003) MISSED OFFSET
	float                                              InteractionDistance;                                      // 0x0280(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EWidgetInteractionSource                           InteractionSource;                                        // 0x0284(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableHitTesting;                                        // 0x0285(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebug;                                               // 0x0286(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0287(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x0288(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData03[0x58];                                      // 0x0298(0x0058) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x02F0(0x0090) (Transient, IsPlainOldData)
	...
	class UWidgetComponent*                            HoveredWidgetComponent;                                   // 0x0390(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0394(0x0004) MISSED OFFSET
	struct FHitResult                                  LastHitResult;                                            // 0x0398(0x0090) (Transient, IsPlainOldData)
...
{
public:
	class UWidget*                                     RootWidget;                                               // 0x001C(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
