...
struct FAnimNode_TwoLeggedIK : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<EBoneDirection>                        FootForwardDirectionLS;                                   // 0x0240(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0241(0x0003) MISSED OFFSET
	float                                              FootMaxPitchOffset;                                       // 0x0244(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxRollOffset;                                        // 0x0248(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxHeightOffset;                                      // 0x024C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SkipEvaluateTimes;                                        // 0x0250(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x0254(0x000C) MISSED OFFSET
	struct FAnimNode_TwoBoneIK                         LegAdapting_L;                                            // 0x0260(0x01A0)
	struct FAnimNode_TwoBoneIK                         LegAdapting_R;                                            // 0x0400(0x01A0)
