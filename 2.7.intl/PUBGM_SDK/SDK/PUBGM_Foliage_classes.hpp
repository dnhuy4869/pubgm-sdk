...
{
public:
	struct FScriptMulticastDelegate                    OnInstanceTakePointDamage;                                // 0x0900(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInstanceTakeRadialDamage;                               // 0x090C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	struct FGuid                                       UpdateGuid;                                               // 0x001C(0x0010) (IsPlainOldData)
	...
	unsigned char                                      UnknownData07[0x3];                                       // 0x010D(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0x6];                                       // 0x0122(0x0006) MISSED OFFSET
	...
	unsigned char                                      UnknownData10[0x1];                                       // 0x026B(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0x2];                                       // 0x0296(0x0002) MISSED OFFSET
	...
	unsigned char                                      UnknownData12[0x6];                                       // 0x030A(0x0006) MISSED OFFSET
...
{
public:
	class UCapsuleComponent*                           CapsuleComponent;                                         // 0x0310(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FVector                                     TouchingActorEntryPosition;                               // 0x0314(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x0320(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x032C(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x0338(0x000C) (Transient, IsPlainOldData)
	float                                              FoliageDamageImpulseScale;                                // 0x0344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageTouchImpulseScale;                                 // 0x0348(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageStiffness;                                         // 0x034C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageStiffnessQuadratic;                                // 0x0350(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FoliageDamping;                                           // 0x0354(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxDamageImpulse;                                         // 0x0358(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxTouchImpulse;                                          // 0x035C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxForce;                                                 // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Mass;                                                     // 0x0364(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AProceduralFoliageVolume*                    ProceduralFoliageVolume;                                  // 0x0330(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                RandomSeed;                                               // 0x001C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x1B];                                      // 0x003D(0x001B) MISSED OFFSET
...
{
public:
	class UProceduralFoliageSpawner*                   FoliageSpawner;                                           // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x78];                                      // 0x0020(0x0078) MISSED OFFSET
...
{
public:
	class UProceduralFoliageComponent*                 ProceduralComponent;                                      // 0x0330(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0334(0x0004) MISSED OFFSET
