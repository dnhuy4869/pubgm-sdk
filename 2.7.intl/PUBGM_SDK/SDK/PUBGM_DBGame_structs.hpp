...
{
	struct FNetArrayUnit                               NetArrayUnit;                                             // 0x0000(0x0048)
	int                                                Index;                                                    // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FNetArrayUnitDBZ>                    IncArray;                                                 // 0x0000(0x000C) (ZeroConstructor)
...
struct FCharacterParticleEffect
{
	...
	unsigned char                                      UnknownData01[0x3C];                                      // 0x0030(0x003C) UNKNOWN PROPERTY: MapProperty DBGame.CharacterParticleEffect.HeroParticleTemplateMap
	TArray<struct FName>                               AttachedSockets;                                          // 0x006C(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<EPawnState>                                 ActivedState;                                             // 0x0078(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FName>                               ExcludeAnimCurveName;                                     // 0x0084(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<EPawnState>                                 ExcludeStates;                                            // 0x0090(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<TEnumAsByte<EMovementMode>>                 ExcludeMovementMode;                                      // 0x009C(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x28];                                      // 0x00A8(0x0028) UNKNOWN PROPERTY: SoftObjectProperty DBGame.CharacterParticleEffect.UsingParticleTemplate
	TMap<struct FName, class UParticleSystemComponent*> RuntimeCachedParticleEffects;                             // 0x00D0(0x0050) (ExportObject, ZeroConstructor, Transient)
...
{
	struct FString                                     ModifyString;                                             // 0x0000(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	float                                              DurationTime;                                             // 0x000C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              EnterTime;                                                // 0x0010(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FRaySegmentedSoundEffect
{
	...
	unsigned char                                      UnknownData04[0x4];                                       // 0x0068(0x0004) MISSED OFFSET
	class UAkComponent*                                AkComp;                                                   // 0x006C(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
};
...
{
	TArray<EPawnState>                                 States;                                                   // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              AboveVelocity;                                            // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ExtendRadius;                                             // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ExtendHalfHeight;                                         // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FDBZHurtFlowStr
{
	...
	TArray<int>                                        WeaponAttachs;                                            // 0x0014(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              WorldTime;                                                // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                KnockOut;                                                 // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                FatalDamage;                                              // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                VictimIsDying;                                            // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AttackerArmorLev;                                         // 0x0030(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                VictimArmorLev;                                           // 0x0034(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     BulletBornPos;                                            // 0x0038(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     BulletHitPos;                                             // 0x0044(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	int                                                BulletFlyDist;                                            // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                HitPointType;                                             // 0x0054(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AttackerInADS;                                            // 0x0058(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              VictimCostHp;                                             // 0x005C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              VictimCostArmor;                                          // 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AttackerCurHp;                                            // 0x0064(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AttackerCurArmor;                                         // 0x0068(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AttackerWeaponLev;                                        // 0x006C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                VictimWeaponLev;                                          // 0x0070(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AttackerIsAI;                                             // 0x0074(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Index;                                                    // 0x0078(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
