...
public:
	...
	EControllerHand                                    Hand;                                                     // 0x0614(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDisableLowLatencyUpdate : 1;                             // 0x0615(0x0001) (Edit, BlueprintVisible)
	ETrackingStatus                                    CurrentTrackingStatus;                                    // 0x0616(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x59];                                      // 0x0617(0x0059) MISSED OFFSET
