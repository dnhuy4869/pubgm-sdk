...
struct FUnitConfig
{
	...
	struct FString                                     BPPath;                                                   // 0x0020(0x000C) (BlueprintVisible, ZeroConstructor)
	bool                                               bTraceGround;                                             // 0x002C(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x002D(0x0003) MISSED OFFSET
	struct FString                                     PreferSpotID;                                             // 0x0030(0x000C) (BlueprintVisible, ZeroConstructor)
};
...
{
	struct FUnitConfig                                 UnitConfig;                                               // 0x0000(0x003C) (BlueprintVisible)
	struct FVector                                     SpawnLocation;                                            // 0x003C(0x000C) (BlueprintVisible, IsPlainOldData)
...
struct FUnitRatio
{
	struct FUnitConfig                                 Unit;                                                     // 0x0000(0x003C) (Edit)
	float                                              Ratio;                                                    // 0x003C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
