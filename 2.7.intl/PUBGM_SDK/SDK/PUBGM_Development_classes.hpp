...
public:
	...
	TArray<class UGMCheatSystem*>                      GMCheatSystems;                                           // 0x00A0(0x000C) (ZeroConstructor)
	class AActor*                                      PVETestMonster;                                           // 0x00AC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x30];                                      // 0x00B0(0x0030) MISSED OFFSET
	TArray<class ASkeletalMeshActor*>                  SkeletalMeshActorPool;                                    // 0x00E0(0x000C) (ZeroConstructor)
