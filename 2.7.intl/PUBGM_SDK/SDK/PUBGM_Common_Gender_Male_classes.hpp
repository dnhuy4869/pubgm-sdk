...
// WidgetBlueprintGeneratedClass Common_Gender_Male.Common_Gender_Male_C
// 0x0008 (0x0260 - 0x0258)
class UCommon_Gender_Male_C : public ULuaUserWidget
{
public:
	...
	static UClass* StaticClass()
	{
        ...
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("WidgetBlueprintGeneratedClass Common_Gender_Male.Common_Gender_Male_C");
		return pStaticClass;
	}
