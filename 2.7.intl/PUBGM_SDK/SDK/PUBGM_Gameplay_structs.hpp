...
struct FGameModePlayerParams
{
	...
	uint64_t                                           PreTeamID;                                                // 0x0050(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                PlayerBornPointID;                                        // 0x0058(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bTeamLeader;                                              // 0x005C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsGM;                                                    // 0x005D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      gender;                                                   // 0x005E(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x005F(0x0001) MISSED OFFSET
	struct FString                                     PIC_URL;                                                  // 0x0060(0x000C) (ZeroConstructor)
	int                                                Level;                                                    // 0x006C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Segment_Level;                                            // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AceImprintShowId;                                         // 0x0074(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AceImprintBaseId;                                         // 0x0078(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AvatarBoxId;                                              // 0x007C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bAIPlayer;                                                // 0x0080(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x0081(0x0007) MISSED OFFSET
	uint64_t                                           MLAIDisplayUID;                                           // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerItem>                 ItemList;                                                 // 0x0090(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 fireworksInfo;                                            // 0x009C(0x000C) (ZeroConstructor)
	TArray<int>                                        equip_plating_list;                                       // 0x00A8(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayerRolewearInfo>         AllWear;                                                  // 0x00B4(0x000C) (ZeroConstructor)
	int                                                RolewearIndex;                                            // 0x00C0(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FGameModePlayerExpressionItem>       ExpressionItemList;                                       // 0x00C4(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayerTaskData>             TaskDataList;                                             // 0x00D0(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 WeaponAvatarList;                                         // 0x00DC(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayerItem>                 VehicleAvatarList;                                        // 0x00E8(0x000C) (ZeroConstructor)
	TArray<struct FVehicleAvatarData>                  VehicleAdvanceAvatarList;                                 // 0x00F4(0x000C) (ZeroConstructor)
	struct FGameModePlayerEquipmentAvatar              EquipmentAvatar;                                          // 0x0100(0x000C)
	TArray<struct FGameModeWeaponDIYPlanData>          WeaponDIYPlanData;                                        // 0x010C(0x000C) (ZeroConstructor)
	int                                                VehicleSkinInReady;                                       // 0x0118(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FGameModePlayerAliasInfo                    AliasInfo;                                                // 0x011C(0x0034)
	struct FGameModePlayerUpassInfo                    UpassInfo;                                                // 0x0150(0x0030)
	struct FGameModePlayerPetInfo                      PetInfo;                                                  // 0x0180(0x001C)
	TArray<struct FGameModePlayerKnapsackExtInfo>      KnapsackExtInfoList;                                      // 0x019C(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      WeaponSchemeInfoList;                                     // 0x01A8(0x000C) (ZeroConstructor)
	int                                                CurWeaponSchemeIndex;                                     // 0x01B4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x01B8(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        CharSkillList;                                            // 0x01BC(0x000C) (ZeroConstructor)
	struct FGameModePlayerBanChat                      banChat;                                                  // 0x01C8(0x0010)
	struct FGameModePlayerBanChat                      banTarget;                                                // 0x01D8(0x0010)
	TArray<struct FSpecialPickItem>                    SpecialPickItem;                                          // 0x01E8(0x000C) (ZeroConstructor)
	struct FAchievementPrize                           EquippedAchievementPrize;                                 // 0x01F4(0x000C)
	TArray<int>                                        audioChat;                                                // 0x0200(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x4];                                       // 0x020C(0x0004) MISSED OFFSET
	struct FName                                       CurrentPlayerState;                                       // 0x0210(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       CurrentCharacterState;                                    // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              SyncedTimestamp;                                          // 0x0220(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DestinyValue;                                             // 0x0224(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              WarmScore;                                                // 0x0228(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AIAllocMarkValue;                                         // 0x022C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                LeaderCount;                                              // 0x0230(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0234(0x0004) MISSED OFFSET
	uint64_t                                           LastGameLeaderUID;                                        // 0x0238(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   LastGameTeammatesUID;                                     // 0x0240(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData07[0x4];                                       // 0x024C(0x0004) MISSED OFFSET
	uint64_t                                           LastGameBattleID;                                         // 0x0250(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              RatingScore;                                              // 0x0258(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bDoPlayerUseAutoFollow;                                   // 0x025C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x025D(0x0003) MISSED OFFSET
	float                                              MaxRankingScore;                                          // 0x0260(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ObserverFlags;                                            // 0x0264(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           WatchPlayerKey;                                           // 0x0268(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsHawkEyeSpectator;                                      // 0x0270(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0271(0x0003) MISSED OFFSET
	int                                                HawkEyeSpectateMaxMatchCount;                             // 0x0274(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HawkEyeSpectateUsedMatchCount;                            // 0x0278(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      PlatformGender;                                           // 0x027C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x027D(0x0003) MISSED OFFSET
	int                                                planeAvatarId;                                            // 0x0280(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DyeDebugFlag;                                             // 0x0284(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     Nation;                                                   // 0x0288(0x000C) (ZeroConstructor)
	int                                                MatchLabel;                                               // 0x0294(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AnchorPlatColorID;                                        // 0x0298(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AnchorPlatResID;                                          // 0x029C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               OnlyTeammateSeeAvatar;                                    // 0x02A0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x7];                                       // 0x02A1(0x0007) MISSED OFFSET
	int64_t                                            LastGameResultTime;                                       // 0x02A8(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CorpsID;                                                  // 0x02B0(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CampID;                                                   // 0x02B8(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bUsedSimulation;                                          // 0x02C0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bRoomCanKickPlayer;                                       // 0x02C1(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCanDownloadInBattle;                                     // 0x02C2(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x1];                                       // 0x02C3(0x0001) MISSED OFFSET
	struct FString                                     IpCountryStr;                                             // 0x02C4(0x000C) (ZeroConstructor)
	bool                                               bRoomOwner;                                               // 0x02D0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x02D1(0x0003) MISSED OFFSET
	int                                                VeteranRecruitIndex;                                      // 0x02D4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MatchStrategyLabel;                                       // 0x02D8(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FDailyTaskStoreInfo>                 DailyTaskStoreList;                                       // 0x02DC(0x000C) (ZeroConstructor)
	int                                                LandId;                                                   // 0x02E8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FollowType;                                               // 0x02EC(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           FollowUID;                                                // 0x02F0(0x0008) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TaskSyncToDsTs;                                           // 0x02F8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x02FC(0x0004) MISSED OFFSET
	uint64_t                                           LuckmateUID;                                              // 0x0300(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                CollectedEventType;                                       // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     GameAPPIDFromDS;                                          // 0x030C(0x000C) (ZeroConstructor)
	float                                              RealHiddenScore;                                          // 0x0318(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	int8_t                                             AIType;                                                   // 0x031C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x031D(0x0003) MISSED OFFSET
	uint32_t                                           AILevel;                                                  // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLAIPlayer;                                              // 0x0324(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLDelivery;                                              // 0x0325(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0326(0x0002) MISSED OFFSET
	uint32_t                                           MLBotType;                                                // 0x0328(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FAttackFlow
{
	...
	float                                              CameraRotationX;                                          // 0x0198(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CameraRotationY;                                          // 0x019C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CameraRotationZ;                                          // 0x01A0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x01A4(0x0004) MISSED OFFSET
};
...
struct FCircleFlow
{
	...
	float                                              TeammateNum;                                              // 0x023C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<int>                                        PlayerStatisticalInfo;                                    // 0x0000(0x000C) (ZeroConstructor)
};
