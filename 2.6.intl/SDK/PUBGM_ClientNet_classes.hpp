...
public:
	...
	class UGCloudSDK*                                  _GCloudSDKInst;                                           // 0x01EC(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               OpenBuglyLogReport;                                       // 0x00DC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00DD(0x0003) MISSED OFFSET
	int                                                MaxBufferSize;                                            // 0x00E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
