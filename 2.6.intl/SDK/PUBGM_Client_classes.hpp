...
public:
	...
	uint64_t                                           GVoiceGameId;                                             // 0x0060(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     GVoiceGameKey;                                            // 0x0068(0x000C) (ZeroConstructor, Config)
	...
	struct FString                                     APPID_WECHAT;                                             // 0x00A4(0x000C) (ZeroConstructor, Config)
	...
	struct FString                                     APPID_QQ;                                                 // 0x00C8(0x000C) (ZeroConstructor, Config)
	...
	struct FString                                     TGPACtrlURL;                                              // 0x00EC(0x000C) (ZeroConstructor, Config)
...
public:
	...
	struct FGameModeAIPlayerParams                     CachedAIPlayerParams;                                     // 0x00B8(0x0318)
	struct FString                                     LuaFilePath;                                              // 0x03D0(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x03DC(0x003C) MISSED OFFSET
...
public:
	...
	static uint64_t GetGVoiceGameId();
...
public:
	...
	class UGVoiceInterface*                            GVoice;                                                   // 0x01F4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsNewGVoiceCreated;                                       // 0x01F8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               DisableGVoice;                                            // 0x01F9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	...
	class UAsyncTaskDownloader*                        DownloadTask;                                             // 0x0228(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x44];                                      // 0x022C(0x0044) MISSED OFFSET
	bool                                               bUseDolphinUpdateFirst;                                   // 0x0270(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseDolphinUpdate;                                  // 0x0271(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseCDNUpdate;                                      // 0x0272(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDolphinUpdateAfterCDNFailed;                          // 0x0273(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseCDNUpdateAfterDolphinFailed;                          // 0x0274(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableEditorPufferDownload;                              // 0x0275(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsWaitingUpdateStateData;                                // 0x0276(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingDolphinUpdate;                                     // 0x0277(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingCDNUpdate;                                         // 0x0278(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x13];                                      // 0x0279(0x0013) MISSED OFFSET
	class UCDNUpdate*                                  CDNUpdater;                                               // 0x028C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ODPaksPoolSize;                                           // 0x0290(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowend;                                     // 0x0294(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowendThreshold;                            // 0x0298(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               ODPaksEnable;                                             // 0x029C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0x23];                                      // 0x029D(0x0023) MISSED OFFSET
	struct FName                                       UnrealNetworkStatus;                                      // 0x02C0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x10];                                      // 0x02C8(0x0010) MISSED OFFSET
	float                                              UnrealNetworkConnectingTimer;                             // 0x02D8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x10];                                      // 0x02DC(0x0010) MISSED OFFSET
	float                                              UnrealNetworkConnectingTime;                              // 0x02EC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDynamicCreateLuaManager;                              // 0x02F0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x02F1(0x0003) MISSED OFFSET
	TArray<struct FString>                             PersistentLuaManager;                                     // 0x02F4(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0300(0x0004) MISSED OFFSET
	bool                                               bPatchReInitSequence;                                     // 0x0304(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x0305(0x0003) MISSED OFFSET
	class ULuaStateWrapper*                            LuaStateWrapper;                                          // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULuaEventBridge*                             LuaEventBridgeInstace;                                    // 0x030C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UBattleWindowMgrLuaUtils*                    LuaBattleWindowMgr;                                       // 0x0310(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULuaBlueprintMgr*                            LuaBlueprintSysMgr;                                       // 0x0314(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0318(0x0004) MISSED OFFSET
	struct FString                                     ScriptBPRelativeDir;                                      // 0x031C(0x000C) (ZeroConstructor, Config)
	struct FString                                     ScriptRelativeDir;                                        // 0x0328(0x000C) (ZeroConstructor, Config)
	struct FString                                     InGameLuaDir;                                             // 0x0334(0x000C) (ZeroConstructor, Config)
	struct FString                                     PreloadLuaFileRelativePath;                               // 0x0340(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             LuaDirList;                                               // 0x034C(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             NoGCPackage;                                              // 0x0358(0x000C) (ZeroConstructor, Config)
	float                                              LuaTickTime;                                              // 0x0364(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCallLuaTick;                                             // 0x0368(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAutoLoginEnable;                                         // 0x0369(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData15[0x1E];                                      // 0x036A(0x001E) MISSED OFFSET
	int                                                PingFirstReportIntervalSecond;                            // 0x0388(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PingReportIntervalSecond;                                 // 0x038C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossSyncIntervalSecond;                                   // 0x0390(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PlayerStatusReportIntervalSecond;                         // 0x0394(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                vmInstrumentOptimization;                                 // 0x0398(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UTssManager*                                 TssMgr;                                                   // 0x039C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x20];                                      // 0x03A0(0x0020) MISSED OFFSET
	float                                              PingReportInterval;                                       // 0x03C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData17[0xDC];                                      // 0x03C4(0x00DC) MISSED OFFSET
	int64_t                                            DeactivatedThreshold;                                     // 0x04A0(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	int64_t                                            TimePassThreshold;                                        // 0x04A8(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ImageDownloadClearDayCount;                               // 0x04B0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FScriptMulticastDelegate                    UIStackChangeDelegate;                                    // 0x04B4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    UIStackRecoverDelegate;                                   // 0x04C0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationUIEvent;                              // 0x04CC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationExUIEvent;                            // 0x04D8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData18[0x5C];                                      // 0x04E4(0x005C) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x0540(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x0544(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x0548(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x054C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x054D(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x054E(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x054F(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x0550(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x0551(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x0552(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x0553(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x0554(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData19[0x3];                                       // 0x0555(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x0558(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x055C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData20[0x3];                                       // 0x055D(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x0560(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x0564(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x0568(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x056C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x0570(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x0574(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x0578(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData21[0x10];                                      // 0x057C(0x0010) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x058C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData22[0x3];                                       // 0x058D(0x0003) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x0590(0x000C) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x059C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnablePandora;                                           // 0x059D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x1];                                       // 0x059E(0x0001) MISSED OFFSET
	bool                                               bEnableJMLog;                                             // 0x059F(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData24[0x84];                                      // 0x05A0(0x0084) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x0624(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCheckWorldNameForLoadConfig;                             // 0x0625(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData25[0x6];                                       // 0x0626(0x0006) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x062C(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x0630(0x000C) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x063C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x063D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData26[0x2];                                       // 0x063E(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x0640(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x0644(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x0648(0x000C) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x0654(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData27[0x8];                                       // 0x0658(0x0008) MISSED OFFSET
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x0660(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData28[0x4];                                       // 0x0658(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x0670(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData29[0x4];                                       // 0x0670(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FString                                     CurrentMapName;                                           // 0x0680(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData30[0x4];                                       // 0x068C(0x0004) MISSED OFFSET
...
public:
	...
	uint32_t                                           openGvoiceLog;                                            // 0x00A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	...
	struct FScriptDelegate                             OnGVoiceEvent;                                            // 0x03D0(0x000C) (ZeroConstructor, InstancedReference)
...
{
public:
	struct FString                                     IntlGameId;                                               // 0x001C(0x000C) (ZeroConstructor, Config)
...
{
public:
	unsigned char                                      UnknownData00[0x2];                                       // 0x0318(0x0002) MISSED OFFSET
	bool                                               bClearSourceCodeAfterInitialized;                         // 0x031A(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x25];                                      // 0x031B(0x0025) MISSED OFFSET
...
public:
	...
	static void TriggerNativeDump(int DumpCount, double Timespan);
	static void TriggerLoginCrashTest(int Type);
	static void TriggerLobbyCrashTest(int Type);
	static void TriggerBlockAndroidANR();
	static void TGPASwitchRichTapMode(const struct FString& Mode);
	static void TGPAStopRichTap();
	static void TGPAStartRichTapWithData(const struct FString& InKey, TMap<struct FString, struct FString> InMapData);
	static void TGPAStartRichTap(const struct FString& Filename);
	static struct FString TGPALoadHeFile(const struct FString& StrFilePath);
	static struct FString TGPAGetRichTapSupport();
	static struct FString TGPAGetRichTapAmplitudeSupport();
	...
	static void Swipe(const struct FString& Path, float duringtime, int start_x, int start_y, int end_x, int end_y, int p_TouchIndex, int p_ControllerId, int screensize_x, int screensize_y);
	...
	static void StartRecordInput(const struct FString& Command);
	static void StartPlayInput();
	...
	static void SetUserTGPATapEnableFlag(int EnableFlag);
	...
	static void SetUIConfigTGPATapEnableFlag(int uiEnable);
	...
	static void SetTGPATapWhiteListFlag(int TapWhiteList);
	...
	static void GetWidgetPathByPos(int start_x, int start_y, int screensize_x, int screensize_y);
	...
	static int GetUserTGPATapEnableFlag();
	...
	static int GetTGPATapDeviceSupportFlag();
	...
	static void GCloudRemoteConfigStartOnce();
	static void GCloudRemoteConfigSetUrl(const struct FString& InRemoteConfigUrl);
	...
	static void GCloudRemoteConfigClear();
	...
	static void EnterBattle(class UGameFrontendHUD* GameFrontendHUD, const struct FString& HostnameOrIP, uint32_t Port, uint32_t PlayerKey, const struct FString& PlayerName, const struct FString& PacketKey, uint64_t GameID, bool IsObserver, TMap<int, struct FString> AdvConfig, int WaterType, uint32_t WaterUserID, uint32_t ModeID, uint32_t ModeType, const struct FString& DynamicLevelsOp);
	...
	static void ClickButton(const struct FString& Path, float duringtime, int start_x, int start_y, int end_x, int end_y, int p_TouchIndex, int p_ControllerId, int screensize_x, int screensize_y, const struct FString& UsePos);
	...
	static void AutoMovePawnToTargetPosClientEx(class UGameFrontendHUD* GameFrontendHUD, const struct FVector& targetPos);
