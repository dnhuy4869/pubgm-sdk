...
// 0x0038 (0x2B068 - 0x2B030)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x2B030(0x0038) MISSED OFFSET
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x030C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x0310(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x0314(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0328(0x0004) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x032C(0x0004) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x0330(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x27];                                      // 0x0331(0x0027) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x0328(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x032C(0x000C) (ZeroConstructor)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0308(0x000C) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0314(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0318(0x000C) (ZeroConstructor)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x036C(0x000C) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0378(0x001C)
	EClientRequestType                                 RequestType;                                              // 0x0394(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0395(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x0396(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x29];                                      // 0x0397(0x0029) MISSED OFFSET
...
public:
	...
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0350(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0351(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0354(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0358(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
