...
struct FCreativeAssetInfo
{
	...
	TArray<struct FCreativeStaticMeshConfigInfo>       StaticMeshes;                                             // 0x002C(0x000C) (ZeroConstructor)
	TArray<struct FCreativeCollisionConfigInfo>        Collisions;                                               // 0x0038(0x000C) (ZeroConstructor)
};
...
struct FCreativeInstanceDataContent
{
	...
	TArray<unsigned char>                              NodeContent;                                              // 0x0004(0x000C) (ZeroConstructor)
};
...
struct FCreativeInstanceDataNode
{
	...
	struct FCreativeInstanceDataContent                DataContent;                                              // 0x0004(0x0010)
};
...
{
	TArray<struct FCreativeModeReplicatNode>           Nodes;                                                    // 0x0088(0x000C) (ZeroConstructor)
...
struct FCreativeInstancceNode
{
	...
	struct FString                                     RuntimeGrid;                                              // 0x0048(0x000C) (ZeroConstructor)
...
struct FCreativeEventBindingChangeInfo
{
	...
	uint32_t                                           BindingInstanceID;                                        // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      FuncIndex;                                                // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData)
