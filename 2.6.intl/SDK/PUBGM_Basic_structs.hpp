...
struct FClientBaseInfo
{
	...
	TMap<struct FString, class UTexture2D*>            AdvTextureList;                                           // 0x00E0(0x0050) (ZeroConstructor)
...
struct FPickupProposeData
{
	...
	TArray<int>                                        SideMirrorList;                                           // 0x00A0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        MirrorList;                                               // 0x00AC(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	int                                                GrenadeYedan;                                             // 0x00C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                DefaultMedicineNum;                                       // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                helmetSubType;                                            // 0x00C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                armorSubType;                                             // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ScoreItemSubType;                                         // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SpecialNoDropItemSubType;                                 // 0x00D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                IceDrinkItemSubType;                                      // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                IsAutoPickUpTaskSubType;                                  // 0x00DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<int>                                        carryOnPlane;                                             // 0x00E0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
