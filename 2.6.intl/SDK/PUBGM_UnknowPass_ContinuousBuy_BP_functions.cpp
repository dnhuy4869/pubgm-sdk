...
// Function UnknowPass_ContinuousBuy_BP.UnknowPass_ContinuousBuy_BP_C.GetSeasonId
// (Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// int                            InSeasonId                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            OutSeasonId                    (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UUnknowPass_ContinuousBuy_BP_C::GetSeasonId(int InSeasonId, int* OutSeasonId)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function UnknowPass_ContinuousBuy_BP.UnknowPass_ContinuousBuy_BP_C.GetSeasonId");

	UUnknowPass_ContinuousBuy_BP_C_GetSeasonId_Params params;
	params.InSeasonId = InSeasonId;
	...
	if (OutSeasonId != nullptr)
		*OutSeasonId = params.OutSeasonId;
}


// Function UnknowPass_ContinuousBuy_BP.UnknowPass_ContinuousBuy_BP_C.SetTypeData
...
void UUnknowPass_ContinuousBuy_BP_C::SetTypeData(int SeasonID, int Level, bool isElite, int Online, int Value, int passType)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function UnknowPass_ContinuousBuy_BP.UnknowPass_ContinuousBuy_BP_C.SetTypeData");

	UUnknowPass_ContinuousBuy_BP_C_SetTypeData_Params params;
