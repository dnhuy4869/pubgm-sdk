...
public:
	...
	bool                                               bUseNewSkillCD;                                           // 0x0440(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x1];                                       // 0x0453(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x3F];                                      // 0x04BD(0x003F) MISSED OFFSET
...
public:
	...
	TMap<int, struct FUTSkillCreateData>               SkillBaseDataMaps;                                        // 0x0278(0x0050) (ZeroConstructor)
	...
	struct FUTSkillHitInfo                             SkillHitInfo;                                             // 0x03B8(0x0028) (Net)
	struct FUTSkillHitEnvInfo                          SkillHitEnvInfo;                                          // 0x03E0(0x0028)
	TArray<struct FString>                             MutexMontageGroupBeenPlayed;                              // 0x0408(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0414(0x0004) MISSED OFFSET
	int                                                SkillSynRandomSeed;                                       // 0x0418(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FRandomStream                               SkillSynRandStream;                                       // 0x041C(0x0008)
	int                                                SkillSynRandomSeedExpireCount;                            // 0x0424(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FString, struct FTimerHandle>          SkillTimerMap;                                            // 0x0428(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData06[0xC];                                       // 0x0464(0x000C) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0xC];                                       // 0x0488(0x000C) MISSED OFFSET
	TArray<struct FUTSkillSynSinglePhaseData>          SkillSynSinglePhaseData;                                  // 0x0494(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	unsigned char                                      UnknownData08[0x1C];                                      // 0x04A0(0x001C) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSkillInitSignature;                                     // 0x04BC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStartEvent;                                          // 0x04C8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStopEvent;                                           // 0x04D4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillLevelChangeEvent;                                    // 0x04E0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TArray<int>                                        PendingRemoveSkillID;                                     // 0x04EC(0x000C) (ZeroConstructor)
	TMap<int, unsigned char>                           CurSKillLevels;                                           // 0x04F8(0x0050) (ZeroConstructor, Transient)
	TArray<struct FUTReplaceSkillData>                 ReplacedSkillDatas;                                       // 0x0534(0x000C) (BlueprintVisible, Net, ZeroConstructor)
	struct FMutilSkillSynData                          NewSkillSynData;                                          // 0x0540(0x0024) (BlueprintVisible, Net)
	struct FSkillSinglePhaseData                       NewSkillSinglePhaseData;                                  // 0x0564(0x0024) (BlueprintVisible, Net)
	bool                                               bEnablePendingStopSkill;                                  // 0x0588(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0589(0x0003) MISSED OFFSET
	TMap<int, struct FUTSkillSimulateData>             PendingRemoveSkillInstMap;                                // 0x058C(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData10[0x3C];                                      // 0x05C8(0x003C) UNKNOWN PROPERTY: SetProperty Skill.UTSkillManagerComponent.AsyncLoadingSkillInst
	struct FUTSkillPreSetBlackboard                    SkillPreSetBlackboard;                                    // 0x0604(0x003C)
	struct FUTSkillExecQueue                           SkillExecQueue;                                           // 0x0640(0x00D0)
