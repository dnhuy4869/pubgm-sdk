...
TEnumAsByte<ESkillMutexType> UUTSkillManagerComponent::GetMutexRelation(int TempSkillID, int InSkillID)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UUTSkillManagerComponent::ClientStopOneSkill(uint64_t InstID, int SkillID, bool bSinglePhaseRep)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UUTSkillManagerComponent::ClientSimulateOneSkill(uint64_t InstID, int SkillID, int PhaseIndex)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
