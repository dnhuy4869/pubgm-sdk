...
struct FAIPlayerState : public FAIStateInfoBase
{
	...
	int                                                Damages;                                                  // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_running;                                               // 0x0074(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_aiming;                                                // 0x0075(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_left_probe;                                            // 0x0076(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_right_probe;                                           // 0x0077(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_floating;                                              // 0x0078(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_diving;                                                // 0x0079(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_vehicle_probe;                                         // 0x007A(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_in_vehicle;                                            // 0x007B(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_firing;                                                // 0x007C(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_holding;                                               // 0x007D(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_stun;                                                  // 0x007E(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_pose_acting;                                           // 0x007F(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_picking;                                               // 0x0080(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_weapon_near_wall;                                      // 0x0081(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0082(0x0002) MISSED OFFSET
	int                                                body_state;                                               // 0x0084(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                location_state;                                           // 0x0088(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               has_smoke;                                                // 0x008C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x008D(0x0003) MISSED OFFSET
	int                                                vehicle_role;                                             // 0x0090(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                player_type;                                              // 0x0094(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               in_delivery_pool;                                         // 0x0098(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0099(0x0003) MISSED OFFSET
	int                                                ai_level;                                                 // 0x009C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               is_move_has_collision;                                    // 0x00A0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               is_lost_connection;                                       // 0x00A1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x00A2(0x0002) MISSED OFFSET
	int                                                revival_count;                                            // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FAINearbyPlayer : public FAIStateInfoBase
{
	...
	struct FAIPlayerState                              State;                                                    // 0x0010(0x00A8)
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x00B8(0x000C)
	struct FAIPlayerEquipment                          equipment;                                                // 0x00C4(0x000C)
};
...
// 0x02DC (0x02E8 - 0x000C)
struct FAIStateInfo : public FAIStateInfoBase
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FAIPlayerState                              State;                                                    // 0x0010(0x00A8)
	struct FAIHeardSound                               Sound;                                                    // 0x00B8(0x000C)
	struct FAIDamageSources                            damage_sources;                                           // 0x00C4(0x0024)
	struct FAIPlayerInteractInfo                       player_interact_info;                                     // 0x00E8(0x0024)
	struct FCameraState                                Camera;                                                   // 0x010C(0x0024)
	struct FAIPlayerWeapon                             Weapon;                                                   // 0x0130(0x000C)
	struct FAIPlayerBackpack                           BackPack;                                                 // 0x013C(0x000C)
	struct FAIPlayerEquipment                          equipment;                                                // 0x0148(0x000C)
	struct FProgressBarState                           progress_bar;                                             // 0x0154(0x0018)
	TArray<struct FAINearbyPlayer>                     nearby_player;                                            // 0x016C(0x000C) (ZeroConstructor)
	TArray<struct FItemStateData>                      nearby_item;                                              // 0x0178(0x000C) (ZeroConstructor)
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x0184(0x000C) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0190(0x000C) (ZeroConstructor)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x019C(0x000C) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x01A8(0x0014)
	struct FSafetyAreaState                            safety_area;                                              // 0x01BC(0x0030)
	struct FRedZoneState                               red_zone;                                                 // 0x01EC(0x0018)
	struct FAIGameState                                Game;                                                     // 0x0204(0x0010)
	uint32_t                                           Key;                                                      // 0x0214(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           deliver_target_id;                                        // 0x0218(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVehicleState                               vehicle_state;                                            // 0x021C(0x0080)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x029C(0x000C) (ZeroConstructor)
	struct FAIBulletHoles                              bullet_holes;                                             // 0x02A8(0x0018)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x02C0(0x000C) (ZeroConstructor)
	TArray<struct FSpecialZoneState>                   special_zones;                                            // 0x02CC(0x000C) (ZeroConstructor)
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x02D8(0x000C) (ZeroConstructor)
	uint32_t                                           ai_style;                                                 // 0x02E4(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FDiffAIPlayerState : public FDiffStateInfoBase
{
	...
	struct FDiffStateInfoBool                          is_stun;                                                  // 0x006E(0x0001)
...
{
	struct FDiffAIPlayerState                          State;                                                    // 0x000C(0x008C)
	struct FDiffAIPlayerWeapon                         Weapon;                                                   // 0x0098(0x0024)
	struct FDiffAIPlayerEquipment                      equipment;                                                // 0x00BC(0x0024)
};
...
// 0x037C (0x0388 - 0x000C)
struct FDiffAIStateInfo : public FDiffStateInfoBase
{
	struct FDiffAIPlayerState                          State;                                                    // 0x000C(0x008C)
	struct FAIHeardSound                               Sound;                                                    // 0x0098(0x000C)
	struct FDiffCameraState                            Camera;                                                   // 0x00A4(0x0030)
	struct FDiffAIPlayerWeapon                         Weapon;                                                   // 0x00D4(0x0024)
	struct FDiffPlayerBackpack                         BackPack;                                                 // 0x00F8(0x0024)
	struct FDiffAIPlayerEquipment                      equipment;                                                // 0x011C(0x0024)
	struct FDiffProgressBarState                       progress_bar;                                             // 0x0140(0x0014)
	struct FDiffAINearbyPlayers                        nearby_player;                                            // 0x0154(0x0024)
	struct FDiffItemStateDatas                         nearby_item;                                              // 0x0178(0x0024)
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x019C(0x000C) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x01A8(0x000C) (ZeroConstructor)
	struct FDiffSafetyAreaState                        safety_area;                                              // 0x01B4(0x0038)
	struct FDiffAIGameState                            Game;                                                     // 0x01EC(0x0014)
	TArray<struct FDoorState>                          nearby_door;                                              // 0x0200(0x000C) (ZeroConstructor)
	struct FDiffRedZoneState                           red_zone;                                                 // 0x020C(0x0024)
	struct FAIDamageSources                            damage_sources;                                           // 0x0230(0x0024)
	uint32_t                                           Key;                                                      // 0x0254(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FItemStateData>                      nearby_box_item;                                          // 0x0258(0x000C) (ZeroConstructor)
	struct FDiffVehicleState                           vehicle_state;                                            // 0x0264(0x007C)
	struct FDiffVehicleStates                          nearby_vehicles;                                          // 0x02E0(0x0024)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0304(0x000C) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0310(0x0014)
	struct FAIBulletHoles                              bullet_holes;                                             // 0x0324(0x0018)
	struct FDiffSpecialZone                            special_zone;                                             // 0x033C(0x0024)
	struct FDiffDynamicItemStates                      dynamic_item_states;                                      // 0x0360(0x0024)
