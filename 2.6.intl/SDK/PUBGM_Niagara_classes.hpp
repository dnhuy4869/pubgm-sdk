...
{
public:
	unsigned char                                      UnknownData00[0xE4];                                      // 0x0610(0x00E4) MISSED OFFSET
	unsigned char                                      bForceSolo : 1;                                           // 0x06F4(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x1C];                                      // 0x06F5(0x001C) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x0711(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x0711(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x0711(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0712(0x0002) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSystemFinished;                                         // 0x0714(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TWeakObjectPtr<class USceneComponent>              AutoAttachParent;                                         // 0x0720(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData)
	struct FName                                       AutoAttachSocketName;                                     // 0x0728(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachLocationRule;                                   // 0x0730(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachRotationRule;                                   // 0x0731(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachScaleRule;                                      // 0x0732(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x0733(0x0001) MISSED OFFSET
	int                                                PreviewDetailLevel;                                       // 0x0734(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	float                                              PreviewLODDistance;                                       // 0x0738(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bEnablePreviewDetailLevel : 1;                            // 0x073C(0x0001) (Edit, Transient)
	unsigned char                                      bEnablePreviewLODDistance : 1;                            // 0x073C(0x0001) (Edit, Transient)
	unsigned char                                      UnknownData04[0x33];                                      // 0x073D(0x0033) MISSED OFFSET
