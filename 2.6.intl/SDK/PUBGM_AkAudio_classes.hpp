...
{
public:
	float                                              Gain;                                                     // 0x0330(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAkAcousticPortalState                             InitialState;                                             // 0x0334(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xB];                                       // 0x0335(0x000B) MISSED OFFSET
...
{
public:
	class UAkAudioEvent*                               AkAudioEvent;                                             // 0x0308(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UAkComponent*                                AkComponent;                                              // 0x030C(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	bool                                               StopWhenOwnerIsDestroyed;                                 // 0x0310(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AutoPost;                                                 // 0x0311(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	ECustomAKAreaType                                  AKAreaType;                                               // 0x0308(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0309(0x0003) MISSED OFFSET
	class UBoxComponent*                               CollisionComponent;                                       // 0x030C(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	bool                                               AutoLoad;                                                 // 0x001C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x13];                                      // 0x001D(0x0013) MISSED OFFSET
...
{
public:
	int                                                SuperHighDefaultPoolSize;                                 // 0x001C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	class UAkAudioBank*                                RequiredBank;                                             // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<uint16_t>                                   TotalPlayCountRecord;                                     // 0x001C(0x000C) (ZeroConstructor)
	...
	struct FScriptDelegate                             AkAudioEventTrigger;                                      // 0x00A0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
...
{
public:
	struct FString                                     BankName;                                                 // 0x0260(0x000C) (Edit, ZeroConstructor)
	struct FString                                     EventName;                                                // 0x026C(0x000C) (Edit, ZeroConstructor)
	EFrequencyRange                                    RangeType;                                                // 0x0278(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0279(0x0003) MISSED OFFSET
	int                                                BinNumber;                                                // 0x027C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x100C];                                    // 0x0280(0x100C) MISSED OFFSET
	bool                                               UseOfflineData;                                           // 0x128C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x128D(0x0003) MISSED OFFSET
	TArray<struct FAudioOfflineVisualBeatData>         OfflineData;                                              // 0x1290(0x000C) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData03[0x24];                                      // 0x129C(0x0024) MISSED OFFSET
...
{
public:
	unsigned char                                      bEnabled : 1;                                             // 0x0330(0x0001) (Deprecated)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0331(0x0003) MISSED OFFSET
	class UAkAuxBus*                                   AuxBus;                                                   // 0x0334(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FString                                     AuxBusName;                                               // 0x0338(0x000C) (ZeroConstructor, Deprecated)
	float                                              SendLevel;                                                // 0x0344(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              FadeRate;                                                 // 0x0348(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              Priority;                                                 // 0x034C(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UAkLateReverbComponent*                      LateReverbComponent;                                      // 0x0350(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	unsigned char                                      MaxSimultaneousReverbVolumes;                             // 0x001C(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	class UAkSurfaceReflectorSetComponent*             SurfaceReflectorSet;                                      // 0x0330(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UAkLateReverbComponent*                      LateReverb;                                               // 0x0334(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UAkRoomComponent*                            room;                                                     // 0x0338(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	class UAkAuxBus*                                   AuxBus;                                                   // 0x0308(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FString                                     AuxBusName;                                               // 0x030C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	class UAkAcousticTexture*                          AcousticTexture;                                          // 0x0318(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DistanceScalingFactor;                                    // 0x031C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Level;                                                    // 0x0320(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0279(0x0003) MISSED OFFSET
	int                                                BinNumber;                                                // 0x027C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<float>                                      BeatTimeArray;                                            // 0x0280(0x000C) (Edit, ZeroConstructor)
	TArray<struct FAudioOfflineVisualBeatData>         Result;                                                   // 0x028C(0x000C) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData01[0x1028];                                    // 0x0298(0x1028) MISSED OFFSET
...
{
public:
	TArray<struct FAudioOfflineVisualBeatData>         OfflineData;                                              // 0x001C(0x000C) (Edit, ZeroConstructor)
