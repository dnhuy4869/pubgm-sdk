...
{
public:
	class ULuaStateWrapper*                            OwningLuaStateWrapper;                                    // 0x0308(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UObject*                                     OwningObject;                                             // 0x030C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UScriptContextComponent*                     ScriptContextComponent;                                   // 0x0310(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FString                                     TestString;                                               // 0x0308(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              TestValue;                                                // 0x0314(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               TestBool;                                                 // 0x0318(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
