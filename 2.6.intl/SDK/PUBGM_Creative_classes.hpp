...
public:
	...
	float                                              WaterHeight;                                              // 0x0D78(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0D7C(0x000C) MISSED OFFSET
	bool                                               bOpenLandPosCheckDebug;                                   // 0x0D88(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bSnapTransValid;                                          // 0x0D89(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bSnapGridEnable;                                          // 0x0D8A(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bForceLandOnGround;                                       // 0x0D8B(0x0001) (ZeroConstructor, IsPlainOldData)
	struct FRotator                                    BuildingRotation;                                         // 0x0D8C(0x000C) (IsPlainOldData)
	struct FRotator                                    RelativeRotation;                                         // 0x0D98(0x000C) (IsPlainOldData)
	struct FVector                                     RelativeLocation;                                         // 0x0DA4(0x000C) (IsPlainOldData)
	struct FVector                                     BuildingScale;                                            // 0x0DB0(0x000C) (IsPlainOldData)
	struct FVector                                     RelativeScale;                                            // 0x0DBC(0x000C) (IsPlainOldData)
...
public:
	...
	struct FEditorObjectLiteComponentTickFunction      LiteComponentActorTick;                                   // 0x03F4(0x003C) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x0430(0x000C) (ZeroConstructor, Transient)
...
{
public:
	unsigned char                                      bIsCreativeMode : 1;                                      // 0x0F38(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	ECreativeModeGameType                              CurrentGameType;                                          // 0x0F39(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	ECreativeModeGameType                              InitializeGameType;                                       // 0x0F3A(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0F3B(0x0001) MISSED OFFSET
	class UCreativeModeGameStateBaseComponent*         CurrentStateComponent;                                    // 0x0F3C(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	class UCreativeModeGameStateBaseComponent*         LastStateComponent;                                       // 0x0F40(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UClass*>                              GameStateComponentClassArray;                             // 0x0F44(0x000C) (ZeroConstructor, Transient)
	class UClass*                                      GameStateComponentClass;                                  // 0x0F50(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FGameStateLiteComponentTickFunction         LiteComponentActorTick;                                   // 0x0F54(0x003C) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x0F90(0x000C) (ZeroConstructor, Transient)
...
public:
	...
	unsigned char                                      UnknownData02[0x224];                                     // 0x01BC(0x0224) MISSED OFFSET
...
public:
	...
	TMap<struct FString, struct FCreativeInstancceNode> CppInstanceTree;                                          // 0x0278(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x4C];                                      // 0x02B4(0x004C) MISSED OFFSET
...
public:
	...
	struct FName                                       CollisionProfileName;                                     // 0x0638(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x30];                                      // 0x0640(0x0030) MISSED OFFSET
...
{
public:
	bool                                               bEnableAutoPickUp;                                        // 0x14B0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x14B1(0x0007) MISSED OFFSET
...
public:
	...
	unsigned char                                      bAsyncLoad : 1;                                           // 0x0760(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0761(0x000F) MISSED OFFSET
