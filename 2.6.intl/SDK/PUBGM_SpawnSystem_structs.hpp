...
struct FUnitConfig
{
	...
	struct FString                                     PreferSpotID;                                             // 0x002C(0x000C) (BlueprintVisible, ZeroConstructor)
};
...
{
	struct FUnitConfig                                 UnitConfig;                                               // 0x0000(0x0038) (BlueprintVisible)
	struct FVector                                     SpawnLocation;                                            // 0x0038(0x000C) (BlueprintVisible, IsPlainOldData)
...
struct FUnitRatio
{
	struct FUnitConfig                                 Unit;                                                     // 0x0000(0x0038) (Edit)
	float                                              Ratio;                                                    // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
