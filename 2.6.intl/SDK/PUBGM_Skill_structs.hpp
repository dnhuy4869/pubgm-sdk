...
struct FUTSkillCreateData
{
	...
	struct FString                                     CoolDownMessage;                                          // 0x0014(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	...
	TArray<class UUTSkillCDBase*>                      SkillCDs;                                                 // 0x0030(0x000C) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x4];                                       // 0x003C(0x0004) MISSED OFFSET
	TArray<struct FName>                               AsyncLoadingSkillUI;                                      // 0x0040(0x000C) (ZeroConstructor, Transient)
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x004C(0x000C) (ExportObject, ZeroConstructor, Transient)
};
...
struct FUTMutilSkillSynData
{
	...
	TArray<unsigned char>                              PhaseIndexArray;                                          // 0x001C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
struct FUTSkillInstance
{
	...
	class UUAEBlackboard*                              Blackboard;                                               // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FUTSkillCreateData                          SkillBaseData;                                            // 0x003C(0x0058)
	TWeakObjectPtr<class AUTSkill>                     CurSkill;                                                 // 0x0094(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillWidget>               CurSkillWidget;                                           // 0x009C(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillManagerComponent>     OwnerComp;                                                // 0x00A4(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	bool                                               bGsListener;                                              // 0x00AC(0x0001) (ZeroConstructor, IsPlainOldData)
