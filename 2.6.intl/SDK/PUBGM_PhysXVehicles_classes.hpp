...
public:
	...
	unsigned char                                      bRestorePhysicsState : 1;                                 // 0x0128(0x0001) (Edit)
	...
	bool                                               bClientSuspensionSweep;                                   // 0x0149(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bServerSuspensionSweep;                                   // 0x014A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UWheeledVehicleMovementComponent*            VehicleMovement;                                          // 0x0350(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
