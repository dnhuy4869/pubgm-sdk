...
struct FGameModePlayerParams
{
	...
	struct FGameModePlayerPetInfo                      PetInfo;                                                  // 0x0174(0x0018)
	TArray<struct FGameModePlayerKnapsackExtInfo>      KnapsackExtInfoList;                                      // 0x018C(0x000C) (ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      WeaponSchemeInfoList;                                     // 0x0198(0x000C) (ZeroConstructor)
	int                                                CurWeaponSchemeIndex;                                     // 0x01A4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x01A8(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        CharSkillList;                                            // 0x01AC(0x000C) (ZeroConstructor)
	struct FGameModePlayerBanChat                      banChat;                                                  // 0x01B8(0x0010)
	struct FGameModePlayerBanChat                      banTarget;                                                // 0x01C8(0x0010)
	TArray<struct FSpecialPickItem>                    SpecialPickItem;                                          // 0x01D8(0x000C) (ZeroConstructor)
	struct FAchievementPrize                           EquippedAchievementPrize;                                 // 0x01E4(0x000C)
	TArray<int>                                        audioChat;                                                // 0x01F0(0x000C) (ZeroConstructor)
	...
	unsigned char                                      UnknownData07[0x4];                                       // 0x023C(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x3];                                       // 0x024D(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData12[0x1];                                       // 0x02B3(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData14[0x4];                                       // 0x02EC(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData15[0x4];                                       // 0x02FC(0x0004) MISSED OFFSET
};
