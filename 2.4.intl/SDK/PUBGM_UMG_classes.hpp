...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0190(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0190(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bIsUseEnhancedHitTest;                                    // 0x01A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVersionImg;                                              // 0x01A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x01A2(0x0002) MISSED OFFSET
	struct FString                                     imageSrcPath;                                             // 0x01A4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              HitTestAreaRadius;                                        // 0x01B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFixOverScale;                                            // 0x01B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01B5(0x0003) MISSED OFFSET
	struct FVector2D                                   ScalePivot;                                               // 0x01B8(0x0008) (Edit, IsPlainOldData)
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01C0(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x01C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bDontPaintWhenAlphaZero;                                  // 0x01D0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenColorZero;                                  // 0x01D1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAsyncLoadImageAsset;                                     // 0x01D2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x5];                                       // 0x01D3(0x0005) MISSED OFFSET
	struct FSoftObjectPath                             AsyncLoadResourcePath;                                    // 0x01D8(0x0018)
	unsigned char                                      UnknownData07[0x10];                                      // 0x01F0(0x0010) MISSED OFFSET
