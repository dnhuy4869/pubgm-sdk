...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x0358(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x0358(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x0358(0x0001)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x0358(0x0001)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x0358(0x0001)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x0358(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0359(0x0003) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x035C(0x0004) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x0360(0x0004) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x0364(0x0004) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0368(0x0004) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x036C(0x0004) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0370(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0374(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x0378(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0384(0x0001) MISSED OFFSET
	bool                                               UseGameplayTasksComponent;                                // 0x0385(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShareNavigationSystem;                                   // 0x0386(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x0387(0x0001) MISSED OFFSET
	struct FVector                                     ShareNavSysOffset;                                        // 0x0388(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableActiveRegion;                                      // 0x0394(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	float                                              DefaultExpirationAge;                                     // 0x001C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	struct FColor                                      DebugColor;                                               // 0x001C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
...
{
public:
	class UBTCompositeNode*                            RootNode;                                                 // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                MaxDebuggerSteps;                                         // 0x001C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	int                                                VerNum;                                                   // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UEnvQueryGenerator*                          Generator;                                                // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UEnvQuery*                                   QueryTemplate;                                            // 0x0604(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0608(0x000C) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0614(0x000C) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0620(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x0624(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x0628(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawLabels : 1;                                          // 0x0629(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x0629(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x0629(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x0629(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x0629(0x0001) (Edit)
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x062A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x15];                                      // 0x062B(0x0015) MISSED OFFSET
...
{
public:
	class UPawnAction*                                 ChildAction;                                              // 0x001C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
