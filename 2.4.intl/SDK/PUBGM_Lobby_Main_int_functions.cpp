...
void ALobby_Main_int_C::InpActEvt_N_K2Node_InputKeyEvent_6(const struct FKey& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Lobby_Main_int.Lobby_Main_int_C.InpActEvt_N_K2Node_InputKeyEvent_6");

	ALobby_Main_int_C_InpActEvt_N_K2Node_InputKeyEvent_6_Params params;
	params.Key = Key;
