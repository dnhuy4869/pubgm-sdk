...
// 0x0B70 (0x0C88 - 0x0118)
class UAbilitySystemComponent : public UGameplayTasksComponent
{
public:
	TArray<struct FAttributeDefaults>                  DefaultStartingData;                                      // 0x0118(0x000C) (Edit, ZeroConstructor)
	TArray<class UAttributeSet*>                       SpawnedAttributes;                                        // 0x0124(0x000C) (ExportObject, Net, ZeroConstructor)
	unsigned char                                      UnknownData00[0x98];                                      // 0x0130(0x0098) MISSED OFFSET
	float                                              OutgoingDuration;                                         // 0x01C8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              IncomingDuration;                                         // 0x01CC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1C];                                      // 0x01D0(0x001C) MISSED OFFSET
	TArray<struct FString>                             ClientDebugStrings;                                       // 0x01EC(0x000C) (Net, ZeroConstructor)
	TArray<struct FString>                             ServerDebugStrings;                                       // 0x01F8(0x000C) (Net, ZeroConstructor)
	struct FGameplayAbilitySpecContainer               ActivatableAbilities;                                     // 0x0204(0x0098) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x029C(0x003C) MISSED OFFSET
	TArray<class UGameplayAbility*>                    AllReplicatedInstancedAbilities;                          // 0x02D8(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x1B0];                                     // 0x02E4(0x01B0) MISSED OFFSET
	TArray<class AGameplayAbilityTargetActor*>         SpawnedTargetActors;                                      // 0x0494(0x000C) (ZeroConstructor)
	struct FGameplayAbilityRepAnimMontage              RepAnimMontageInfo;                                       // 0x04A0(0x0020) (Net)
	unsigned char                                      UnknownData04[0x4];                                       // 0x04C0(0x0004) MISSED OFFSET
	struct FGameplayAbilityLocalAnimMontage            LocalAnimMontageInfo;                                     // 0x04C4(0x0018)
	unsigned char                                      UnknownData05[0x8C];                                      // 0x04DC(0x008C) MISSED OFFSET
	class AActor*                                      OwnerActor;                                               // 0x0568(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	class AActor*                                      AvatarActor;                                              // 0x056C(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x0570(0x000C) MISSED OFFSET
	struct FActiveGameplayEffectsContainer             ActiveGameplayEffects;                                    // 0x057C(0x031C) (Net)
	struct FActiveGameplayCueContainer                 ActiveGameplayCues;                                       // 0x0898(0x009C) (Net)
	struct FActiveGameplayCueContainer                 MinimalReplicationGameplayCues;                           // 0x0934(0x009C) (Net)
	unsigned char                                      UnknownData07[0xE0];                                      // 0x09D0(0x00E0) MISSED OFFSET
	TArray<unsigned char>                              BlockedAbilityBindings;                                   // 0x0AB0(0x000C) (Net, ZeroConstructor, Transient)
	unsigned char                                      UnknownData08[0xE0];                                      // 0x0ABC(0x00E0) MISSED OFFSET
	struct FMinimalReplicationTagCountMap              MinimalReplicationTags;                                   // 0x0B9C(0x0044) (Net)
	unsigned char                                      UnknownData09[0x10];                                      // 0x0BE0(0x0010) MISSED OFFSET
	struct FReplicatedPredictionKeyMap                 ReplicatedPredictionKeyMap;                               // 0x0BF0(0x0094) (Net)
...
{
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x0348(0x000C) MISSED OFFSET
	class UAbilitySystemComponent*                     AbilitySystemComponent;                                   // 0x0354(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FGameplayAbilityTargetingLocationInfo       StartLocation;                                            // 0x02F0(0x0060) (BlueprintVisible, BlueprintReadOnly, Net)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0350(0x0028) MISSED OFFSET
	class APlayerController*                           MasterPC;                                                 // 0x0378(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UGameplayAbility*                            OwningAbility;                                            // 0x037C(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bDestroyOnConfirmation;                                   // 0x0380(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0381(0x0003) MISSED OFFSET
	class AActor*                                      SourceActor;                                              // 0x0384(0x0004) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	struct FWorldReticleParameters                     ReticleParams;                                            // 0x0388(0x000C) (BlueprintVisible)
	class UClass*                                      ReticleClass;                                             // 0x0394(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGameplayTargetDataFilterHandle             Filter;                                                   // 0x0398(0x0008) (BlueprintVisible, Net)
	bool                                               bDebug;                                                   // 0x03A0(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x17];                                      // 0x03A1(0x0017) MISSED OFFSET
	class UAbilitySystemComponent*                     GenericDelegateBoundASC;                                  // 0x03B8(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FCollisionProfileName                       TraceProfile;                                             // 0x03C0(0x0008) (Edit, BlueprintVisible, Config)
	bool                                               bTraceAffectsAimPitch;                                    // 0x03C8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x03C9(0x0017) MISSED OFFSET
...
public:
	...
	bool                                               bFaceOwnerFlat;                                           // 0x02F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSnapToTargetedActor;                                     // 0x02F9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetValid;                                           // 0x02FA(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTargetAnActor;                                         // 0x02FB(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class APlayerController*                           MasterPC;                                                 // 0x02FC(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AActor*                                      TargetingActor;                                           // 0x0300(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class UActorComponent*>                     VisualizationComponents;                                  // 0x0308(0x000C) (ExportObject, ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData00[0x13C];                                     // 0x0088(0x013C) MISSED OFFSET
	TArray<class UClass*>                              LoadedGameplayCueNotifyClasses;                           // 0x01C4(0x000C) (ZeroConstructor, Transient)
	TArray<class UClass*>                              GameplayCueClassesForPreallocation;                       // 0x01D0(0x000C) (ZeroConstructor, Transient)
	TArray<struct FGameplayCuePendingExecute>          PendingExecuteCues;                                       // 0x01DC(0x000C) (ZeroConstructor, Transient)
	int                                                GameplayCueSendContextCount;                              // 0x01E8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<struct FPreallocationInfo>                  PreallocationInfoList_Internal;                           // 0x01EC(0x000C) (ZeroConstructor, Transient)
...
{
public:
	bool                                               WarnIfTimelineIsStillRunning;                             // 0x02F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               WarnIfLatentActionIsStillRunning;                         // 0x02F1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x02F2(0x0006) MISSED OFFSET
	struct FGameplayTag                                GameplayCueTag;                                           // 0x02F8(0x0008) (Edit, DisableEditOnInstance)
	struct FGameplayTagReferenceHelper                 ReferenceHelper;                                          // 0x0300(0x0008) (Edit)
	struct FName                                       GameplayCueName;                                          // 0x0308(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bAutoAttachToOwner;                                       // 0x0310(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsOverride;                                               // 0x0311(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerInstigator;                             // 0x0312(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUniqueInstancePerSourceObject;                           // 0x0313(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleOnActiveEvents;                             // 0x0314(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bAllowMultipleWhileActiveEvents;                          // 0x0315(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0316(0x0002) MISSED OFFSET
	int                                                NumPreallocatedInstances;                                 // 0x0318(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x34];                                      // 0x031C(0x0034) MISSED OFFSET
...
{
public:
	TArray<struct FGameplayEffectAttributeCaptureDefinition> RelevantAttributesToCapture;                              // 0x001C(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
