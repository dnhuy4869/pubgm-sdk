...
struct FUTSkillCreateData
{
	...
	TArray<class UUTSkillCDBase*>                      SkillCDs;                                                 // 0x002C(0x000C) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0038(0x0004) MISSED OFFSET
	TArray<struct FName>                               AsyncLoadingSkillUI;                                      // 0x003C(0x000C) (ZeroConstructor, Transient)
	TArray<class UUTSkillEventEffectMapForEditor*>     EditorEventEffectMap;                                     // 0x0048(0x000C) (ExportObject, ZeroConstructor, Transient)
};
...
struct FUTMutilSkillSynData
{
	...
	int                                                SynID;                                                    // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FUTSkillInstance
{
	...
	int                                                SkillSlot;                                                // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Level;                                                    // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ActiveState;                                              // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkillCD;                                                  // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	EUTSkillStopReason                                 StopReason;                                               // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	TArray<TEnumAsByte<EUTSkillEventType>>             EventCache;                                               // 0x0024(0x000C) (ZeroConstructor)
	class UUAEBlackboard*                              Blackboard;                                               // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FUTSkillCreateData                          SkillBaseData;                                            // 0x0034(0x0054)
	TWeakObjectPtr<class AUTSkill>                     Skill;                                                    // 0x0088(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillWidget>               SkillWidget;                                              // 0x0090(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UUTSkillManagerComponent>     OwnerComp;                                                // 0x0098(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bGsListener;                                              // 0x00A0(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<struct FUAEBlackboardKeySelector>           KeySelectors;                                             // 0x0000(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
};
