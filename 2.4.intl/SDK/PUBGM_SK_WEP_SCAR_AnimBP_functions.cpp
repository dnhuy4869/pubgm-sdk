...
void USK_WEP_SCAR_AnimBP_C::HandleWeaponStateChanged(TEnumAsByte<EFreshWeaponStateType> Selection)
{
...
void USK_WEP_SCAR_AnimBP_C::OnWeaponChangeState(TEnumAsByte<EFreshWeaponStateType> CurState)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
