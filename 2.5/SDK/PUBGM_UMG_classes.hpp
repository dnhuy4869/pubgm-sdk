...
public:
	...
	struct FVector2D                                   LocalHitLocation;                                         // 0x0378(0x0008) (Transient, IsPlainOldData)
	struct FVector2D                                   LastLocalHitLocation;                                     // 0x0380(0x0008) (Transient, IsPlainOldData)
	class UWidgetComponent*                            HoveredWidgetComponent;                                   // 0x0388(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
