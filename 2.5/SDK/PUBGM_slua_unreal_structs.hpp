...
struct FileMemInfo
{
	struct FString                                     hint;                                                     // 0x0000(0x000C) (ZeroConstructor)
	struct FString                                     LineNumber;                                               // 0x000C(0x000C) (ZeroConstructor)
	float                                              Size;                                                     // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              difference;                                               // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
};
