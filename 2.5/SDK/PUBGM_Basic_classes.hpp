...
{
public:
	int                                                iRegionActor;                                             // 0x0380(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0384(0x0002) MISSED OFFSET
	bool                                               bStaticAddNetworkActor;                                   // 0x0386(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x0387(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TArray<struct FBuffManagerModPath>                 BuffListPathMap;                                          // 0x02F8(0x000C) (ZeroConstructor, Config)
...
{
public:
	unsigned char                                      UnknownData00[0x44];                                      // 0x0038(0x0044) MISSED OFFSET
	TMap<struct FName, struct FString>                 ActionParams;                                             // 0x007C(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FString                                     LuaFilePath;                                              // 0x00B8(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	TMap<struct FName, struct FString>                 ActionParams;                                             // 0x006C(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
{
public:
	bool                                               bUseBoneRetargetLODFeature;                               // 0x0AE0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0AE1(0x000F) MISSED OFFSET
...
// 0x0270 (0x29818 - 0x295A8)
class UUAENetConnection : public UIpConnection
{
public:
	unsigned char                                      UnknownData00[0x7C];                                      // 0x295A8(0x007C) MISSED OFFSET
	int                                                InitialHandshakeTimeoutNumThreshold;                      // 0x29624(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x29628(0x0004) MISSED OFFSET
	int                                                ActorChannelProcessBunchErrorNumThreshold_Server_Global;  // 0x2962C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_Global;  // 0x29630(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_PerActor;// 0x29634(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x29638(0x003C) MISSED OFFSET
	bool                                               bEnableHTTPDNS;                                           // 0x29674(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x29675(0x0003) MISSED OFFSET
	struct FString                                     HTTPDNSServerAddr;                                        // 0x29678(0x000C) (ZeroConstructor, Config)
	float                                              HTTPDNSResponseTimeout;                                   // 0x29684(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10];                                      // 0x29688(0x0010) MISSED OFFSET
	float                                              CheckLevelInitializedTime;                                // 0x29698(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckLevelActorsOvertime;                                 // 0x2969C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              TempCheckLevelInitializedTime;                            // 0x296A0(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, struct FUnLoadLevelActorCollection> UnLevelInitActors;                                        // 0x296A4(0x0050) (ZeroConstructor)
	class UNetRelevancyGroup*                          RelevancyGroup;                                           // 0x296E0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC8];                                      // 0x296E4(0x00C8) MISSED OFFSET
	TArray<struct FPendingRegionNetworkObject>         PendingRegionNetworkObjects;                              // 0x297AC(0x000C) (ZeroConstructor)
	float                                              MinRegionActorTickDelta;                                  // 0x297B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxRegionActorTickDelta;                                  // 0x297BC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x297C0(0x000C) MISSED OFFSET
	bool                                               EnableWeakNetUpdate;                                      // 0x297CC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x297CD(0x0003) MISSED OFFSET
	float                                              MinWeakNetUpdateDelay;                                    // 0x297D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxWeakNetUpdateDelay;                                    // 0x297D4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SquareSegmentSize;                                        // 0x297D8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxSegmentDistance;                                       // 0x297DC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxObjectNumInSegments;                                   // 0x297E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0xD];                                       // 0x297E4(0x000D) MISSED OFFSET
	bool                                               bRecreateSocketOnLost;                                    // 0x297F1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x12];                                      // 0x297F2(0x0012) MISSED OFFSET
	float                                              UpdateClientPingTimeThreshold;                            // 0x29804(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x10];                                      // 0x29808(0x0010) MISSED OFFSET
