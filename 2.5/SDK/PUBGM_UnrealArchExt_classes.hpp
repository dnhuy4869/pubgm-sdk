...
public:
	...
	struct FString                                     LuaFilePath;                                              // 0x0398(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	bool                                               bEnableBlueprintTick;                                     // 0x03A4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UBackendHUD*                                 OwningBackendHUD;                                         // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UEngine*                                     Engine;                                                   // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UFrontendHUD*                                OwningFrontendHUD;                                        // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x5C];                                      // 0x014C(0x005C) MISSED OFFSET
	...
	unsigned char                                      UnknownData02[0x28];                                      // 0x0258(0x0028) MISSED OFFSET
