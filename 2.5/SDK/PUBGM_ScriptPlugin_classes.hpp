...
{
public:
	class UObject*                                     OwningObject;                                             // 0x02F0(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UScriptContextComponent*                     ScriptContextComponent;                                   // 0x02F4(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	float                                              TestValue;                                                // 0x02F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               TestBool;                                                 // 0x02FC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
