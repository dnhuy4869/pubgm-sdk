...
{
public:
	struct FScriptMulticastDelegate                    OnEndReached;                                             // 0x001C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	unsigned char                                      UnknownData01[0x1C];                                      // 0x00C0(0x001C) MISSED OFFSET
...
{
public:
	unsigned char                                      Loop : 1;                                                 // 0x001C(0x0001) (Edit, BlueprintVisible)
