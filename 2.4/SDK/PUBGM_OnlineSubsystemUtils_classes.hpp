...
// 0x0038 (0x295E8 - 0x295B0)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x295B0(0x0038) MISSED OFFSET
...
{
public:
	float                                              BeaconConnectionInitialTimeout;                           // 0x02F0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x02F4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x02F8(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x030C(0x0004) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x0310(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x27];                                      // 0x0311(0x0027) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x0308(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x030C(0x000C) (ZeroConstructor)
...
public:
	...
	class UClass*                                      ClientBeaconActorClass;                                   // 0x02F8(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x14];                                      // 0x0338(0x0014) MISSED OFFSET
	struct FString                                     DestSessionId;                                            // 0x034C(0x000C) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0358(0x001C)
	EClientRequestType                                 RequestType;                                              // 0x0374(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0375(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x0376(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x29];                                      // 0x0377(0x0029) MISSED OFFSET
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x28];                                      // 0x030C(0x0028) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0334(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0335(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0338(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x033C(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
