...
{
public:
	TArray<struct FUIParticleEmitterInfo>              Emitters;                                                 // 0x001C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
{
public:
	EEmitterType                                       EmitterType;                                              // 0x001C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
