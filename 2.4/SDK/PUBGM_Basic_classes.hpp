...
public:
	...
	class APawn*                                       OwnerPawnForBuff;                                         // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FClientBaseInfo                             ClientBaseInfo;                                           // 0x01D0(0x0120)
	struct FScriptMulticastDelegate                    EnginePreTick;                                            // 0x02F0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x44];                                      // 0x02FC(0x0044) MISSED OFFSET
	class UFrontendHUD*                                AssociatedFrontendHUD;                                    // 0x0340(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0344(0x0004) MISSED OFFSET
	class ULuaStateWrapper*                            LuaStateWrapper;                                          // 0x0348(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bStandAloneFromLobby;                                     // 0x034C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1B];                                      // 0x034D(0x001B) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnPreBattleResult;                                        // 0x0368(0x000C) (BlueprintVisible, ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0374(0x0008) MISSED OFFSET
	TArray<struct FString>                             HighWeatherNames;                                         // 0x037C(0x000C) (ZeroConstructor, Config)
	int                                                HighWeatherMinRenderQuality;                              // 0x0388(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	int                                                HighWeatherMaxRenderQuality;                              // 0x038C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	struct FAttrDynamicModifier                        DynamicModifier;                                          // 0x0258(0x007C)
	unsigned char                                      UnknownData03[0x3C];                                      // 0x02D4(0x003C) MISSED OFFSET
	TArray<struct FAttributeExpand>                    AttributeExpands;                                         // 0x0310(0x000C) (Edit, ZeroConstructor)
	TMap<struct FString, struct FRelateAttributeGroup> RelateAttributeGroup;                                     // 0x031C(0x0050) (ZeroConstructor)
	EActorRegAttrTableType                             ActorAttrType;                                            // 0x0358(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC7];                                      // 0x0359(0x00C7) MISSED OFFSET
	TArray<struct FModAttrSimulateSyncItem>            ModSimulateSyncList;                                      // 0x0420(0x000C) (Net, ZeroConstructor)
	unsigned char                                      UnknownData05[0xCC];                                      // 0x042C(0x00CC) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x3C];                                      // 0x02B4(0x003C) UNKNOWN PROPERTY: SetProperty Basic.STBuffSystemComponent.BriefRemoveInstIds
	unsigned char                                      UnknownData01[0xE0];                                      // 0x02F0(0x00E0) MISSED OFFSET
	...
	void UpdateClientBuff(int InstID, int BuffID, int LayerCount, int CauseSkillID, int Level, class AActor* CauseActor, float DSEndTime);
	void UpdateBriefs();
...
{
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x0B60(0x000C) MISSED OFFSET
	class UBackendHUD*                                 AssociatedBackendHUD;                                     // 0x0B6C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0B70(0x000C) MISSED OFFSET
	bool                                               bEnableAutoStat;                                          // 0x0B7C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableAutoTickDeltaThreshold;                            // 0x0B7D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0B7E(0x0002) MISSED OFFSET
	float                                              AutoTickDeltaThresholdFactor;                             // 0x0B80(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              StatCollection_AvgTickDeltaThreshold;                     // 0x0B84(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              AutoStat_AvgTickDeltaThreshold;                           // 0x0B88(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              AutoStat_StartTime;                                       // 0x0B8C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0B90(0x0004) MISSED OFFSET
	float                                              AutoStat_Duration_Engine;                                 // 0x0B94(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              AutoStat_Duration_PhysX;                                  // 0x0B98(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x0B9C(0x000C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData00[0x14C];                                     // 0x00DC(0x014C) MISSED OFFSET
...
// 0x0250 (0x29838 - 0x295E8)
class UUAENetConnection : public UIpConnection
{
public:
	unsigned char                                      UnknownData00[0x7C];                                      // 0x295E8(0x007C) MISSED OFFSET
	int                                                InitialHandshakeTimeoutNumThreshold;                      // 0x29664(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x29668(0x0004) MISSED OFFSET
	int                                                ActorChannelProcessBunchErrorNumThreshold_Server_Global;  // 0x2966C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_Global;  // 0x29670(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_PerActor;// 0x29674(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x29678(0x003C) MISSED OFFSET
	bool                                               bEnableHTTPDNS;                                           // 0x296B4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x296B5(0x0003) MISSED OFFSET
	struct FString                                     HTTPDNSServerAddr;                                        // 0x296B8(0x000C) (ZeroConstructor, Config)
	float                                              HTTPDNSResponseTimeout;                                   // 0x296C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10];                                      // 0x296C8(0x0010) MISSED OFFSET
	float                                              CheckLevelInitializedTime;                                // 0x296D8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckLevelActorsOvertime;                                 // 0x296DC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              TempCheckLevelInitializedTime;                            // 0x296E0(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FName, struct FUnLoadLevelActorCollection> UnLevelInitActors;                                        // 0x296E4(0x0050) (ZeroConstructor)
	class UNetRelevancyGroup*                          RelevancyGroup;                                           // 0x29720(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xA4];                                      // 0x29724(0x00A4) MISSED OFFSET
	TArray<struct FPendingRegionNetworkObject>         PendingRegionNetworkObjects;                              // 0x297C8(0x000C) (ZeroConstructor)
	float                                              MinRegionActorTickDelta;                                  // 0x297D4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxRegionActorTickDelta;                                  // 0x297D8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0xC];                                       // 0x297DC(0x000C) MISSED OFFSET
	bool                                               EnableWeakNetUpdate;                                      // 0x297E8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x297E9(0x0003) MISSED OFFSET
	float                                              MinWeakNetUpdateDelay;                                    // 0x297EC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxWeakNetUpdateDelay;                                    // 0x297F0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SquareSegmentSize;                                        // 0x297F4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxSegmentDistance;                                       // 0x297F8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxObjectNumInSegments;                                   // 0x297FC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0xD];                                       // 0x29800(0x000D) MISSED OFFSET
	bool                                               bRecreateSocketOnLost;                                    // 0x2980D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x12];                                      // 0x2980E(0x0012) MISSED OFFSET
	float                                              UpdateClientPingTimeThreshold;                            // 0x29820(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x14];                                      // 0x29824(0x0014) MISSED OFFSET
