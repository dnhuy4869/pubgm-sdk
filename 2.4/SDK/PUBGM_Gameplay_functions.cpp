...
// (Native, Event, Public, BlueprintEvent)
// Parameters:
// class UBattleItemHandleBase*   NewBackPackBagAvatar           (Parm, ZeroConstructor, IsPlainOldData)
// EBattleItemUseReason           reson                          (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UBackpackComponent::PreCheckCanPickupBagAvatar(class UBattleItemHandleBase* NewBackPackBagAvatar, EBattleItemUseReason reson)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
	...
	params.NewBackPackBagAvatar = NewBackPackBagAvatar;
	params.reson = reson;
...
class UAnimationAsset* UUAEChaParachuteAnimListComponent::GetCharacterParachuteAnim(TEnumAsByte<ECharacterParachuteAnimType> AnimType)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
// Function Gameplay.UAELevelSequenceActor.GetPossessableByName
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FString                 NameKeyString                  (Parm, ZeroConstructor)
// struct FMovieSceneObjectBindingID ReturnValue                    (Parm, OutParm, ReturnParm)

struct FMovieSceneObjectBindingID AUAELevelSequenceActor::GetPossessableByName(const struct FString& NameKeyString)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Gameplay.UAELevelSequenceActor.GetPossessableByName");

	AUAELevelSequenceActor_GetPossessableByName_Params params;
