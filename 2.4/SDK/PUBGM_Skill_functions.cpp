...
// struct FUTSkillBBUploadData    SkillBBUploadData              (ConstParm, Parm, OutParm, ReferenceParm)

void UUTSkillManagerComponent::TriggerEvent_WithID(int InSkillID, TEnumAsByte<EUTSkillEventType> InEventType, const struct FUTSkillBBUploadData& SkillBBUploadData)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
	...
	params.SkillBBUploadData = SkillBBUploadData;
...
void UUTSkillManagerComponent::ServerTriggerEvent_WithParams(int SkillID, TEnumAsByte<EUTSkillEventType> EventType, TArray<struct FUAEBlackboardKeySelector> KeySelectors, TArray<unsigned char> Content)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UUTSkillManagerComponent::ServerTriggerEvent_WithID(int SkillID, TEnumAsByte<EUTSkillEventType> EventType)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
// (Final, Native, Public)
// Parameters:
// TArray<class UUTSkillPhase*>   ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)
