...
// Function BattleItemHandle_WeapAttachment.BattleItemHandle_WeapAttachment_C.ClearWeaponActor
// (Public, BlueprintCallable, BlueprintEvent)

void UBattleItemHandle_WeapAttachment_C::ClearWeaponActor()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function BattleItemHandle_WeapAttachment.BattleItemHandle_WeapAttachment_C.ClearWeaponActor");

	UBattleItemHandle_WeapAttachment_C_ClearWeaponActor_Params params;
...
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
// TEnumAsByte<ESurviveWeaponPropSlot> Slot                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class ASTExtraBaseCharacter*   ACharacter                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UItemHandleBase*         NewParam                       (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UBattleItemHandle_WeapAttachment_C::GetItemBaseBySlot(TEnumAsByte<ESurviveWeaponPropSlot> Slot, class ASTExtraBaseCharacter* ACharacter, class UItemHandleBase** NewParam)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
