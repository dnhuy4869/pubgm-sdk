...
public:
	...
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x0330(0x003C) (Net)
	struct FString                                     LuaFilePath;                                              // 0x036C(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x44];                                      // 0x0378(0x0044) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x44];                                      // 0x0350(0x0044) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x44];                                      // 0x0590(0x0044) MISSED OFFSET
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x05D4(0x003C) (Net)
	struct FString                                     LuaFilePath;                                              // 0x0610(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x02F0(0x0040) MISSED OFFSET
	struct FString                                     LuaFilePath;                                              // 0x0330(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
