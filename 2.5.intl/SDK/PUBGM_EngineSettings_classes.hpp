...
{
public:
	int                                                MaxScrollbackSize;                                        // 0x001C(0x0004) (Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData)
...
{
public:
	int                                                MinDynamicBandwidth;                                      // 0x001C(0x0004) (Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData)
...
{
public:
	int                                                MaxSpectators;                                            // 0x001C(0x0004) (Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData)
...
{
public:
	struct FString                                     CompanyName;                                              // 0x001C(0x000C) (Edit, ZeroConstructor, Config)
	...
	struct FText                                       ProjectDisplayedTitle;                                    // 0x00A4(0x0018) (Edit, Config)
	struct FText                                       ProjectDebugTitleInfo;                                    // 0x00B0(0x0018) (Edit, Config)
...
{
public:
	unsigned char                                      bShowHUD : 1;                                             // 0x001C(0x0001) (Edit, Config)
