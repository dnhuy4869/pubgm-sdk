...
{
public:
	unsigned char                                      UnknownData00[0x40];                                      // 0x0C88(0x0040) MISSED OFFSET
	struct FString                                     LuaFilePath;                                              // 0x0CC8(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	TArray<class UClass*>                              PreloadedAbilities;                                       // 0x0CD4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FGameplayAbilitySpecHandle>          PreloadedAbilityHandles;                                  // 0x0CE0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x0CEC(0x003C) (Net)
