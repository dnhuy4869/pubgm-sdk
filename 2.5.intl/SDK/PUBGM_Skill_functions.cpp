...
// Function Skill.UTSkill.GetRestCoolDownTime
// (Native, Public, BlueprintCallable)
// Parameters:
// class UUTSkillManagerComponent* SkillManagerComponent          (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
// int                            CoolDownIndex                  (Parm, ZeroConstructor, IsPlainOldData)
...
float AUTSkill::GetRestCoolDownTime(class UUTSkillManagerComponent* SkillManagerComponent, int CoolDownIndex)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Skill.UTSkill.GetRestCoolDownTime");

	AUTSkill_GetRestCoolDownTime_Params params;
	params.SkillManagerComponent = SkillManagerComponent;
	params.CoolDownIndex = CoolDownIndex;
...
// Function Skill.UTSkillManagerComponent.UseSkillInstance
// (Final, Native, Public, Const)
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UUTSkillManagerComponent::UseSkillInstance()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Skill.UTSkillManagerComponent.UseSkillInstance");

	UUTSkillManagerComponent_UseSkillInstance_Params params;
...
// Function Skill.UTSkillManagerComponent.OnAsyncLoadOneSkill
// (Final, Native, Public, HasOutParms)
// Parameters:
// class AUTSkill*                InNewSkill                     (Parm, ZeroConstructor, IsPlainOldData)
// uint64_t                       InstID                         (Parm, ZeroConstructor, IsPlainOldData)
// int                            SkillID                        (Parm, ZeroConstructor, IsPlainOldData)
// TArray<int>                    PhaseIndexArray                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)

void UUTSkillManagerComponent::OnAsyncLoadOneSkill(class AUTSkill* InNewSkill, uint64_t InstID, int SkillID, TArray<int> PhaseIndexArray)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Skill.UTSkillManagerComponent.OnAsyncLoadOneSkill");

	UUTSkillManagerComponent_OnAsyncLoadOneSkill_Params params;
	params.InNewSkill = InNewSkill;
	params.InstID = InstID;
	params.SkillID = SkillID;
	params.PhaseIndexArray = PhaseIndexArray;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// TEnumAsByte<EUTSkillEventType> SkillEvent                     (Parm, ZeroConstructor, IsPlainOldData)

void UUTSkillWidget::TriggerPassiveEvent(TEnumAsByte<EUTSkillEventType> SkillEvent)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UUTSkillWidget::TriggerEvent(TEnumAsByte<EUTSkillEventType> SkillEvent)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
