...
// 0x0450 (0x0740 - 0x02F0)
class UVehicleAnimInstance : public UAnimInstance
{
public:
	unsigned char                                      UnknownData00[0x440];                                     // 0x02F0(0x0440) MISSED OFFSET
	class UWheeledVehicleMovementComponent*            WheeledVehicleMovementComponent;                          // 0x0730(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0734(0x000C) MISSED OFFSET
...
public:
	...
	bool                                               bSuspensionSweep;                                         // 0x0149(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bClientSuspensionSweep;                                   // 0x014A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bServerSuspensionSweep;                                   // 0x014B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0xC];                                       // 0x01D4(0x000C) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x2B];                                      // 0x0245(0x002B) MISSED OFFSET
...
{
public:
	class UStaticMesh*                                 CollisionMesh;                                            // 0x001C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
{
public:
	class USkeletalMeshComponent*                      Mesh;                                                     // 0x0330(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UWheeledVehicleMovementComponent*            VehicleMovement;                                          // 0x0334(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
