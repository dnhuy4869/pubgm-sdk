...
struct FUnitConfig
{
	...
	struct FString                                     PreferSpotID;                                             // 0x0020(0x000C) (BlueprintVisible, ZeroConstructor)
};
...
{
	struct FUnitConfig                                 UnitConfig;                                               // 0x0000(0x002C) (BlueprintVisible)
	struct FVector                                     SpawnLocation;                                            // 0x002C(0x000C) (BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0038(0x0008) MISSED OFFSET
	struct FTransform                                  Transform;                                                // 0x0040(0x0030) (BlueprintVisible, IsPlainOldData)
	int                                                AttributeID;                                              // 0x0070(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	uint32_t                                           SpawnerID;                                                // 0x0074(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FUnitRatio
{
	struct FUnitConfig                                 Unit;                                                     // 0x0000(0x002C) (Edit)
	float                                              Ratio;                                                    // 0x002C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
