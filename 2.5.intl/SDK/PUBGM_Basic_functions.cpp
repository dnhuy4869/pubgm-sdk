...
// Function Basic.STBuffCondition_Lua.GetVectorValue
// (Final, Native, Public, HasOutParms, HasDefaults, Const)
// Parameters:
// struct FName                   Key                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// struct FVector                 ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FVector USTBuffCondition_Lua::GetVectorValue(const struct FName& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Basic.STBuffCondition_Lua.GetVectorValue");

	USTBuffCondition_Lua_GetVectorValue_Params params;
	params.Key = Key;
...
// Function Basic.STBuffCondition_Lua.GetStringValue
// (Final, Native, Public, HasOutParms, Const)
// Parameters:
// struct FName                   Key                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// struct FString                 ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

struct FString USTBuffCondition_Lua::GetStringValue(const struct FName& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Basic.STBuffCondition_Lua.GetStringValue");

	USTBuffCondition_Lua_GetStringValue_Params params;
	params.Key = Key;
...
// Function Basic.STBuffCondition_Lua.GetIntValue
// (Final, Native, Public, HasOutParms, Const)
// Parameters:
// struct FName                   Key                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int USTBuffCondition_Lua::GetIntValue(const struct FName& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Basic.STBuffCondition_Lua.GetIntValue");

	USTBuffCondition_Lua_GetIntValue_Params params;
	params.Key = Key;
...
// Function Basic.STBuffCondition_Lua.GetFloatValue
// (Final, Native, Public, HasOutParms, Const)
// Parameters:
// struct FName                   Key                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

float USTBuffCondition_Lua::GetFloatValue(const struct FName& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Basic.STBuffCondition_Lua.GetFloatValue");

	USTBuffCondition_Lua_GetFloatValue_Params params;
	params.Key = Key;
...
// Function Basic.STBuffCondition_Lua.GetBoolValue
// (Final, Native, Public, HasOutParms, Const)
// Parameters:
// struct FName                   Key                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool USTBuffCondition_Lua::GetBoolValue(const struct FName& Key)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Basic.STBuffCondition_Lua.GetBoolValue");

	USTBuffCondition_Lua_GetBoolValue_Params params;
	params.Key = Key;
