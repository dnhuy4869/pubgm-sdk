...
public:
	...
	class UCloudSDK*                                   _CloudSDKInst;                                            // 0x01EC(0x0004) (ZeroConstructor, IsPlainOldData)
	...
	void OnHDmpveStateChangeNotify(int State, int Param1, int Param2, int param3);
	void OnHDmpveDisconnectedNotify(int Result);
	void OnHDmpveConnectedNotify(int IsConnected, int nResult);
...
// Class ClientNet.CloudSDK
// 0x00CC (0x00E8 - 0x001C)
class UCloudSDK : public UObject
{
public:
	unsigned char                                      UnknownData00[0xC0];                                      // 0x001C(0x00C0) MISSED OFFSET
	int                                                MaxBufferSize;                                            // 0x00DC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class ClientNet.CloudSDK");
		return pStaticClass;
	}
...
// Class ClientNet.CloudSDKDelegates
// 0x00E4 (0x0100 - 0x001C)
class UCloudSDKDelegates : public UObject
{
public:
	struct FScriptMulticastDelegate                    ConnectNotifyDelegate;                                    // 0x001C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class ClientNet.CloudSDKDelegates");
		return pStaticClass;
	}
...
{
public:
	struct FString                                     IMSDK_GAME_ID;                                            // 0x001C(0x000C) (ZeroConstructor, Config)
...
{
public:
	bool                                               isBindFB;                                                 // 0x001C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               isBindGPGC;                                               // 0x001D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               isBindGP;                                                 // 0x001E(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               isBindGC;                                                 // 0x001F(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                nCloudChannelID;                                          // 0x0020(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
