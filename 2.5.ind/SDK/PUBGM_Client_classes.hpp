...
{
public:
	int                                                PUBLISH_REGION_ID;                                        // 0x001C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	...
	uint64_t                                           AntsVoiceGameId;                                          // 0x0060(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     AntsVoiceGameKey;                                         // 0x0068(0x000C) (ZeroConstructor, Config)
	...
	struct FString                                     term_106CtrlURL;                                          // 0x00EC(0x000C) (ZeroConstructor, Config)
...
{
public:
	TMap<struct FString, class UObject*>               PreloadObjectMap;                                         // 0x001C(0x0050) (ZeroConstructor)
...
public:
	...
	struct FGameModeAIPlayerParams                     CachedAIPlayerParams;                                     // 0x00B8(0x0310)
	struct FString                                     LuaFilePath;                                              // 0x03C8(0x000C) (ZeroConstructor, Config)
...
{
public:
	struct FString                                     branch_name;                                              // 0x001C(0x000C) (ZeroConstructor, Config)
...
public:
	...
	static uint64_t GetAntsVoiceGameId();
	...
	static void AddKnownMissingPackage(const struct FString& PackageName, class UObject* BindObj, bool bReplace);
};
...
// Class Client.CamScanner
// 0x003C (0x0058 - 0x001C)
class UCamScanner : public UObject
{
public:
	class UTextureRenderTarget2D*                      WebCamRenderTarget;                                       // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMaterial*                                   WebCamMaterial;                                           // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMediaPlayer*                                WebCamPlayer;                                             // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bScanning;                                                // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0029(0x0007) MISSED OFFSET
	struct FScriptDelegate                             OnScanSuccess;                                            // 0x0030(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0029(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FString                                     WebCamMaterialPath;                                       // 0x0040(0x000C) (ZeroConstructor)
	struct FString                                     WebCamPlayerPath;                                         // 0x004C(0x000C) (ZeroConstructor)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Client.CamScanner");
		return pStaticClass;
	}


	void OnCamaraOpened(const struct FString& OpenURL);
};
...
// 0x04A8 (0x0608 - 0x0160)
class UGameFrontendHUD : public UFrontendHUD
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0160(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnGetTicketNotifyDelegate;                                // 0x0168(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHandleServerListDownload;                               // 0x0174(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnUIStatReport;                                           // 0x0180(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnReportClientTool;                                       // 0x018C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FString                                     CSVTableRelativeDir;                                      // 0x0198(0x000C) (ZeroConstructor, Config)
	TMap<struct FName, struct FString>                 GameStatusMap;                                            // 0x01A4(0x0050) (ZeroConstructor)
	bool                                               EnableTickLog;                                            // 0x01E0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x01E1(0x0001) MISSED OFFSET
	bool                                               bEnableReportMemory;                                      // 0x01E2(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x11];                                      // 0x01E3(0x0011) MISSED OFFSET
	class UAnsVoiceInterface*                          VoiceInterface;                                           // 0x01F4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsNewVoiceCreated;                                        // 0x01F8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               DisableAntsVoice;                                         // 0x01F9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x01FA(0x0002) MISSED OFFSET
	class UBugReporter*                                GameBugReporter;                                          // 0x01FC(0x0004) (ZeroConstructor, IsPlainOldData)
	class UGMLogShare*                                 LogShare;                                                 // 0x0200(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxUpdateRetryTimes;                                      // 0x0204(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0208(0x0008) MISSED OFFSET
	class UGDolphinUpdater*                            GDolphin;                                                 // 0x0210(0x0004) (ZeroConstructor, IsPlainOldData)
	class UTranslator*                                 Translator;                                               // 0x0214(0x0004) (ZeroConstructor, IsPlainOldData)
	class UHttpWrapper*                                HttpWrapper;                                              // 0x0218(0x0004) (ZeroConstructor, IsPlainOldData)
	class UGCPufferDownloader*                         GPuffer;                                                  // 0x021C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULaggingReporter*                            LaggingReporter;                                          // 0x0220(0x0004) (ZeroConstructor, IsPlainOldData)
	class UCamScanner*                                 CamScanner;                                               // 0x0224(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0228(0x0004) MISSED OFFSET
	class UAsyncTaskDownloader*                        DownloadTask;                                             // 0x022C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x44];                                      // 0x0230(0x0044) MISSED OFFSET
	bool                                               bUseDolphinUpdateFirst;                                   // 0x0274(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseDolphinUpdate;                                  // 0x0275(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseCDNUpdate;                                      // 0x0276(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDolphinUpdateAfterCDNFailed;                          // 0x0277(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseCDNUpdateAfterDolphinFailed;                          // 0x0278(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableEditorPufferDownload;                              // 0x0279(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsWaitingUpdateStateData;                                // 0x027A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingDolphinUpdate;                                     // 0x027B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingCDNUpdate;                                         // 0x027C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x13];                                      // 0x027D(0x0013) MISSED OFFSET
	class UCDNUpdate*                                  CDNUpdater;                                               // 0x0290(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ODPaksPoolSize;                                           // 0x0294(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowend;                                     // 0x0298(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowendThreshold;                            // 0x029C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               ODPaksEnable;                                             // 0x02A0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0x27];                                      // 0x02A1(0x0027) MISSED OFFSET
	...
	unsigned char                                      UnknownData10[0x10];                                      // 0x02E4(0x0010) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0x3];                                       // 0x02F9(0x0003) MISSED OFFSET
	TArray<struct FString>                             PersistentLuaManager;                                     // 0x02FC(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0308(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData14[0x4];                                       // 0x0320(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData15[0x1E];                                      // 0x0372(0x001E) MISSED OFFSET
	int                                                PingFirstReportIntervalSecond;                            // 0x0390(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PingReportIntervalSecond;                                 // 0x0394(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossSyncIntervalSecond;                                   // 0x0398(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                vmInstrumentOptimization;                                 // 0x039C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UTssManager*                                 TssMgr;                                                   // 0x03A0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x14];                                      // 0x03A4(0x0014) MISSED OFFSET
	float                                              PingReportInterval;                                       // 0x03B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData17[0x9C];                                      // 0x03BC(0x009C) MISSED OFFSET
	uint32_t                                           ImageDownloadClearDayCount;                               // 0x0458(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FScriptMulticastDelegate                    UIStackChangeDelegate;                                    // 0x045C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    UIStackRecoverDelegate;                                   // 0x0468(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationUIEvent;                              // 0x0474(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationExUIEvent;                            // 0x0480(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData18[0x5C];                                      // 0x048C(0x005C) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x04E8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x04EC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x04F0(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x04F4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x04F5(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x04F6(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x04F7(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x04F8(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x04F9(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x04FA(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x04FB(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x04FC(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData19[0x3];                                       // 0x04FD(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x0500(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x0504(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData20[0x3];                                       // 0x0505(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x0508(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x050C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x0510(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x0514(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x0518(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x051C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x0520(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData21[0x10];                                      // 0x0524(0x0010) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x0534(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData22[0x3];                                       // 0x0535(0x0003) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x0538(0x000C) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x0544(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnablePandora;                                           // 0x0545(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x1];                                       // 0x0546(0x0001) MISSED OFFSET
	bool                                               bEnableJMLog;                                             // 0x0547(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData24[0x84];                                      // 0x0548(0x0084) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x05CC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCheckWorldNameForLoadConfig;                             // 0x05CD(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData25[0x6];                                       // 0x05CE(0x0006) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x05D4(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x05D8(0x000C) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x05E4(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x05E5(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData26[0x2];                                       // 0x05E6(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x05E8(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x05EC(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x05F0(0x000C) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x05FC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData27[0x8];                                       // 0x0600(0x0008) MISSED OFFSET
	...
	void SetScannerSuccessDelegate(const struct FScriptDelegate& OnScanSuccess);
	...
	void OnCloudNetStateChangeNotify(int State, int EventParam1, int EventParam2, int EventParam3);
	...
	class UAnsVoiceInterface* GetVoiceInterface();
...
{
public:
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData04[0x13B];                                     // 0x015D(0x013B) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnResponseEvent;                                          // 0x001C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	unsigned char                                      UnknownData00[0x4C];                                      // 0x0034(0x004C) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnSuccess;                                                // 0x001C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	struct FString                                     InttGameId;                                               // 0x001C(0x000C) (ZeroConstructor, Config)
...
{
public:
	TMap<struct FString, class ULuaBluepirntSys*>      SystemMap;                                                // 0x001C(0x0050) (ZeroConstructor)
...
{
public:
	class UGameBusinessManager*                        pManager;                                                 // 0x02F8(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x02FC(0x0002) MISSED OFFSET
	bool                                               bClearSourceCodeAfterInitialized;                         // 0x02FE(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x21];                                      // 0x02FF(0x0021) MISSED OFFSET
...
{
public:
	bool                                               bIgnoreStretch;                                           // 0x0210(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0211(0x0003) MISSED OFFSET
	int                                                MaskType;                                                 // 0x0214(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   MaskTransformPivot;                                       // 0x0218(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   MaskTransformScale;                                       // 0x0220(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              MaskTransformAngle;                                       // 0x0228(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskMaterial;                                             // 0x022C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  MaskTexture;                                              // 0x0230(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnScreenTouch;                                            // 0x001C(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMouseButtonUp;                                          // 0x0028(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMouseButtonDown;                                        // 0x0038(0x000C) (ZeroConstructor, InstancedReference)
...
public:
	...
	static void UQMCrashKitPutUserData(const struct FString& Key, const struct FString& Value);
	static void UQMCrashKitPostExceptionFull(int Category, const struct FString& Name, const struct FString& Msg, const struct FString& stack);
	static void UQMCrashKitPostException(int Category, const struct FString& Reason);
	static void UQMCrashKitLog(int Level, const struct FString& Tag, const struct FString& Log, bool needDump);
	...
	static void term_106SwitchRichTapMode(const struct FString& Mode);
	static void term_106StopRichTap();
	static void term_106StartRichTapWithData(const struct FString& InKey, TMap<struct FString, struct FString> InMapData);
	static void term_106StartRichTap(const struct FString& Filename);
	static struct FString term_106LoadHeFile(const struct FString& StrFilePath);
	static struct FString term_106GetRichTapSupport();
	static struct FString term_106GetRichTapAmplitudeSupport();
	static void term_104Report(int Type, const struct FString& ExtraInfo, bool send);
	static void term_104PostLargeValueS(const struct FString& catgory, const struct FString& Key, const struct FString& Value);
	static void term_104MarkTime(int Type);
	static void term_104MarkLevelFin();
	static void term_104DisconnectReport(class UGameFrontendHUD* GameFrontendHUD, int EventId);
	static void term_104DataReport(class UGameFrontendHUD* GameFrontendHUD, int EventId, const struct FString& EventInfo);
	...
	static void SyncLoadPackageInitialize(const struct FString& CfgFilename);
	static void SyncLoadPackageInit(const struct FString& ConfigFilename);
	...
	static void SyncLoadPackageDumpInfo(const struct FString& DumpFilename);
	...
	static void StopScanning(class UGameFrontendHUD* GameFrontendHUD);
	...
	static void StartScanning(class UGameFrontendHUD* GameFrontendHUD);
	...
	static void SetUserterm_106TapEnableFlag(int EnableFlag);
	...
	static void SetUIConfigterm_106TapEnableFlag(int uiEnable);
	...
	static void Setterm_106TapWhiteListFlag(int TapWhiteList);
	...
	static void SetScannerSuccessDelegate(class UGameFrontendHUD* GameFrontendHUD, const struct FScriptDelegate& OnScanSuccess);
	...
	static void ReportCrashKitLogWithFDNum(const struct FString& baseLogInfo);
	...
	static void ReInitAppLocalFiles();
	...
	static void PostGameStatusToterm_106SMap(class UGameFrontendHUD* GameFrontendHUD, const struct FString& Key, TMap<struct FString, struct FString> mapData);
	...
	static void NosChatShareWithMiniApp(const struct FString& _userName, const struct FString& _descShare, const struct FString& _titleShare, const struct FString& _imgPath, const struct FString& _webpageUrl, int _shareScene, const struct FString& _path, const struct FString& _messageExt, const struct FString& _messageAction, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	...
	static bool HasDownloadedBasePak();
	static bool HasDefinePermission(const struct FString& InPermissionName);
	...
	static int GetUserterm_106TapEnableFlag();
	...
	static int Getterm_106TapDeviceSupportFlag();
	...
	static struct FString GetRuntimeProfileData();
	...
	static struct FString GetGameModuleBaseAddr(const struct FString& ParamModuleName);
	...
	static struct FString GetAppFilesRootDir();
	static struct FString GetAOSSHOP();
	static void GetAntsvoiceReconnectInfo(class UGameFrontendHUD* GameFrontendHUD, TMap<struct FString, struct FString> Data);
	...
	static void GameSimulateActionClientEx(class UGameFrontendHUD* GameFrontendHUD, int SimulateType);
	...
	static void EnterBattle(class UGameFrontendHUD* GameFrontendHUD, const struct FString& HostnameOrIP, uint32_t Port, uint32_t PlayerKey, const struct FString& PlayerName, const struct FString& PacketKey, uint64_t GameID, bool IsObserver, TMap<int, struct FString> AdvConfig, int WaterType, uint32_t WaterUserID, uint32_t ModeID, uint32_t ModeType);
	...
	static void EnableReportAntsVoiceEvent(class UGameFrontendHUD* GameFrontendHUD, bool VoiceInitVoiceComponentReportEnable, bool VoiceJoinRoomReportEnable, bool VoiceQuitRoomReportEnable, bool VoiceJoinLbsRoomReportEnable, bool VoiceQuitLbsRoomReportEnable, bool VoiceOnJoinTeamRoomReportEnable, bool VoiceOnJoinLbsRoomReportEnable);
	...
	static void EnableCampAntsvoice(class UGameFrontendHUD* GameFrontendHUD, bool Enable);
	static void EnableAutoObjectRefreshStage(bool bEnable);
	static void EnableAudioRouteChangedNotify(bool Enable);
	static void EnableAntsvoiceGemReport(class UGameFrontendHUD* GameFrontendHUD, bool Enable);
	static void EnableAntsvoice(class UGameFrontendHUD* GameFrontendHUD, bool Enable);
	...
	static void CrashKitSetAppVersion(const struct FString& Version, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	static void CrashKitPutUserData(const struct FString& Key, const struct FString& Value, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	static void CrashKitPostExceptionFull(int Category, const struct FString& Name, const struct FString& Msg, const struct FString& stack, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	static void CrashKitPostException(int Category, const struct FString& Reason, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	static void CrashKitLog(int Level, const struct FString& Tag, const struct FString& Log, bool needDump, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	...
	static void ConnectToURLWithDNSProxy(const struct FString& URL, int ConnectTimeOutSeconds, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	...
	static void BgBgShareToFriend(const struct FString& targetUrl, int act, const struct FString& OpenID, const struct FString& Title, const struct FString& Desc, const struct FString& msdkExtInfo, const struct FString& imgUrl, const struct FString& previewText, const struct FString& gameTag, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	static void BgBgShareH5WithPhoto(const struct FString& _title, const struct FString& _fullURL, int Channel, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	static void BgBgShare(const struct FString& _imgPath, const struct FString& _descShare, const struct FString& _titleShare, int _shareScene, const struct FString& _imgUrl, const struct FString& _url, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	static void BgBgAddFriend(const struct FString& OpenID, const struct FString& Desc, const struct FString& Message, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	...
	static void AutoTestSpawnAI(int ID, float PosiX, float PosiY, float PosiZ);
	...
	static struct FVector2D AutoTestPickupItem(int ItemID);
	...
	static bool AutoTestIsCurrentCommandFinished();
	...
	static void AutoTestGetRenderTimeDetail();
	static void AutoTestGetPrimitivesDetail();
	static void AutoTestGetOnVehicle(int SeatType);
	static void AutoTestGetOffVehicle();
	static struct FVector AutoTestGetNearVehiclePos();
	static void AutoTestGetMemoryDetail();
	...
	static void AutoTestGetDrawCallDetail();
	...
	static TArray<int> AutoTestGetAvailableDeadBoxItem();
	...
	static void AutoTestForceDeleteCmdAnim();
...
{
public:
	struct FScriptMulticastDelegate                    SDKCallbackDelegate;                                      // 0x001C(0x000C) (ZeroConstructor, InstancedReference)
...
public:
	...
	struct FScriptDelegate                             GetUserSettingsDelegate;                                  // 0x00F0(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData03[0x48];                                      // 0x0140(0x0048) MISSED OFFSET
...
{
public:
	struct FString                                     SubscriptionKey;                                          // 0x001C(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config)
	struct FString                                     StoredAccessToken;                                        // 0x0028(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
	struct FScriptDelegate                             OnGetAccessTokenDelegate;                                 // 0x0038(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0034(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnDetectDelegate;                                         // 0x0048(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0048(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnTranslateDelegate;                                      // 0x0058(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0058(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData04[0x50];                                      // 0x0068(0x0050) MISSED OFFSET
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x00B8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x24];                                      // 0x00BC(0x0024) MISSED OFFSET
...
{
public:
	struct FString                                     TssHostInfo;                                              // 0x001C(0x000C) (ZeroConstructor, Config)
...
public:
	...
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0410(0x000C) (Edit, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x040C(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
// Class Client.AnsVoiceInterface
// 0x0424 (0x0440 - 0x001C)
class UAnsVoiceInterface : public UObject
{
public:
	...
	struct FScriptDelegate                             CheckTempLbsRoomOnJoinRoom;                               // 0x0040(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CheckTempLbsRoomOnQuitRoom;                               // 0x0050(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0050(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnSTTReportCallback;                                      // 0x0060(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0060(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRSTSCallback;                                           // 0x0070(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0070(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnRSTSSpeechToTextCallback;                               // 0x0080(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0080(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData07[0xC];                                       // 0x0090(0x000C) MISSED OFFSET
	struct FString                                     ServerInfo;                                               // 0x009C(0x000C) (ZeroConstructor, Config)
	uint32_t                                           openAntsvoiceLog;                                         // 0x00A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           MicVolumeMUFactor;                                        // 0x00AC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           SpeekerVolumeMUFactor;                                    // 0x00B0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                RoomOperationTimeout;                                     // 0x00B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x00B8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x74];                                      // 0x00BC(0x0074) MISSED OFFSET
	struct FScriptDelegate                             OpenMicFail;                                              // 0x0130(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData09[0x4];                                       // 0x00BC(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenMicSuccess;                                           // 0x0140(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData10[0x4];                                       // 0x0140(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseMicFail;                                             // 0x0150(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0150(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseMicSuccess;                                          // 0x0160(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0160(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenSpeakerFail;                                          // 0x0170(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0170(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OpenSpeakerSuccess;                                       // 0x0180(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0180(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseSpeakerFail;                                         // 0x0190(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData15[0x4];                                       // 0x0190(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             CloseSpeakerSuccess;                                      // 0x01A0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData16[0x4];                                       // 0x01A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinRoomFail;                                             // 0x01B0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData17[0x4];                                       // 0x01B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinRoomNotify;                                           // 0x01C0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData18[0x4];                                       // 0x01C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitRoomNotify;                                           // 0x01D0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData19[0x4];                                       // 0x01D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinLbsRoomNotify;                                        // 0x01E0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData20[0x4];                                       // 0x01E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitLbsRoomNotify;                                        // 0x01F0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData21[0x4];                                       // 0x01F0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RoomStatusUpdatedNotify;                                  // 0x0200(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData22[0x4];                                       // 0x0200(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SetAppInfoSuccess;                                        // 0x0210(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData23[0x4];                                       // 0x0210(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SetAppInfoFail;                                           // 0x0220(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData24[0x4];                                       // 0x0220(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             GetReconnectInfo;                                         // 0x0230(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData25[0x4];                                       // 0x0230(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ImSpeakingNotify;                                         // 0x0240(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData26[0x4];                                       // 0x0240(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             TestMicFail;                                              // 0x0250(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData27[0x4];                                       // 0x0250(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             TestMicSuccess;                                           // 0x0260(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData28[0x4];                                       // 0x0260(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             QuitRoomFail;                                             // 0x0270(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData29[0x4];                                       // 0x0270(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DownLoadFileNotify;                                       // 0x0280(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData30[0x4];                                       // 0x0280(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SpeechToTextNotify;                                       // 0x0290(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData31[0x4];                                       // 0x0290(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadFileNotify;                                         // 0x02A0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData32[0x4];                                       // 0x02A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x02B0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData33[0x4];                                       // 0x02B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x02C0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData34[0x4];                                       // 0x02C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x02D0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData35[0x4];                                       // 0x02D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x02E0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData36[0x4];                                       // 0x02E0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x02F0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData37[0x4];                                       // 0x02F0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RecordSuccess;                                            // 0x0300(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData38[0x4];                                       // 0x0300(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RecordFail;                                               // 0x0310(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData39[0x4];                                       // 0x0310(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadSuccess;                                            // 0x0320(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData40[0x4];                                       // 0x0320(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             UploadFail;                                               // 0x0330(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData41[0x4];                                       // 0x0330(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SpeechToTextSuccess;                                      // 0x0340(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData42[0x4];                                       // 0x0340(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             SpeechToTextFail;                                         // 0x0350(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData43[0x4];                                       // 0x0350(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DownloadFileSuccess;                                      // 0x0360(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData44[0x4];                                       // 0x0360(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             DownloadFileFail;                                         // 0x0370(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData45[0x4];                                       // 0x0370(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             EnableRoomMicrophone;                                     // 0x0380(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData46[0x4];                                       // 0x0380(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             ExitInfectionGameMode;                                    // 0x0390(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData47[0x4];                                       // 0x0390(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             JoinInfectionGameMode;                                    // 0x03A0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData48[0x4];                                       // 0x03A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             RequestPrivacyInSetting;                                  // 0x03B0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData49[0x4];                                       // 0x03B0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnReportPlayerCallback;                                   // 0x03C0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData50[0x4];                                       // 0x03C0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             OnAntsVoiceEvent;                                         // 0x03D0(0x000C) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData51[0x4];                                       // 0x03D0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData52[0x60];                                      // 0x03E0(0x0060) MISSED OFFSET

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Client.AnsVoiceInterface");
		return pStaticClass;
	}
	...
	void SetAntsVoiceSupportBackgroundChat(bool isSupportBGChat);
	void SetAntsVoiceChatServiceEnable(bool IsEnable);
	...
	int EnableAntsVoiceRoomMicrophone(const struct FString& InRoomName, bool InEnable);
