...
// Function GlobalUIFunctionLibrary.GlobalUIFunctionLibrary_C.GetVoiceInterface
// (Static, Public, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UAnsVoiceInterface*      outputObj                      (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UGlobalUIFunctionLibrary_C::GetVoiceInterface(class UObject* __WorldContext, class UAnsVoiceInterface** outputObj)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function GlobalUIFunctionLibrary.GlobalUIFunctionLibrary_C.GetVoiceInterface");

	UGlobalUIFunctionLibrary_C_GetVoiceInterface_Params params;
	params.__WorldContext = __WorldContext;
