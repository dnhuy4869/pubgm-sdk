...
{
public:
	TArray<struct FDeviceRenderConfig>                 DeviceRenderConfigs;                                      // 0x001C(0x000C) (ZeroConstructor, Config)
	TArray<struct FMapRenderConfig>                    MapRenderConfigs;                                         // 0x0028(0x000C) (ZeroConstructor, Config)
